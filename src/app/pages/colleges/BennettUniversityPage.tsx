...
import { 
  ...
  Car, Building2, Waves,Stethoscope, Activity, Bone, Syringe, Pill, Ambulance,Gavel, Scale,
  Radio,Video,BookMarked,CircuitBoard
} from 'lucide-react';
...
export function BennettUniversityPage() {
  ...
  const college = {
    ...
    location: 'Plot No 8-11, TechZone II, Greater Noida, Uttar Pradesh - 201310',
    rating: 4.3,
    students: '11,500+',
    ...
    established: '2016',
    affiliation: 'UGC, AICTE, BCI, NCTE',
    accreditation: ['NAAC A', 'ISO 9001:2015', 'ISO 14001:2015', 'ISO 45001:2018', 'ISO 50001:2018'],
    ...
    courses: [
      ...
      'B.Tech CSE (IoT & Robotics)',
      'B.Tech CSE (Quantum Computing)',
      'B.Tech CSE (Product Design Technology)',
      'B.Tech CSE (DevOps)',
      'B.Tech CSE (Full Stack)',
      'B.Tech CSE (Mobile Technologies)',
      'B.Tech CSE (UI/UX)',
      ...
      'B.Tech M.Tech Biotech Integrated',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        eligibility: '10+2 with PCM with minimum 65% marks. JEE Main/Bennett Test qualified.',
        fees: '₹3,80,000/year',
        perSemesterFees: '₹1,94,000/semester',
        totalFees: '₹15,20,000 (Total for 4 years)',
        seats: 360,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'Blockchain', 'Gaming', 'AR/VR', 'IoT', 'Quantum Computing'],
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['NVIDIA AI Lab', 'Apple iOS Development Centre', 'Intel Center of Excellence', 'Research Opportunities']
      },
      'B.Tech CSE AI': {
        ...
        eligibility: '10+2 with PCM with minimum 65% marks. JEE Main/Bennett Test qualified.',
        fees: '₹4,50,000/year',
        perSemesterFees: '₹2,29,500/semester',
        totalFees: '₹18,00,000 (Total for 4 years)',
        seats: 120,
        specializations: ['Machine Learning', 'Deep Learning', 'Natural Language Processing', 'Computer Vision', 'Robotics'],
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['AI Specialization', 'NVIDIA DGX H100 Super Computer', 'Research Opportunities']
      },
      'B.Tech CSE DS': {
        ...
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['Data Science Specialization', 'Industry Projects', 'Research Opportunities']
      },
      'B.Tech CSE Global': {
        name: 'B.Tech CSE Global (2+2 with Iowa State University, USA)',
        duration: '4 Years (2+2)',
        eligibility: '10+2 with PCM with minimum 60% marks. JEE Main/Bennett Test qualified.',
        fees: '₹3,80,000/year (1st 2 years)',
        perSemesterFees: '₹1,94,000/semester',
        totalFees: '₹7,60,000 (1st 2 years) + USA fees',
        seats: 60,
        specializations: ['Computer Science', 'Software Engineering'],
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['Dual Degree with Iowa State University, USA', 'Global Exposure', 'International Faculty']
      },
      'B.Tech ECE': {
        ...
        eligibility: '10+2 with PCM with minimum 60% marks. JEE Main/Bennett Test qualified.',
        fees: '₹3,60,000/year',
        perSemesterFees: '₹1,84,500/semester',
        totalFees: '₹14,40,000 (Total for 4 years)',
        seats: 120,
        specializations: ['Data & Signal Analytics', 'IoT & Embedded Systems', 'VLSI Design', 'Mechatronics'],
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['Advanced Electronics Labs', 'PCB Design Lab', 'Robotics Lab']
      },
      'B.Tech ME': {
        ...
        totalFees: '₹14,40,000 (Total for 4 years)',
        seats: 120,
        specializations: ['Aerospace Engineering', 'E-Mobility', 'Energy Technologies', 'Industrial Engineering', 'Mechatronics', 'Robotics', 'Product Design', 'AI & ML'],
        entranceExam: 'JEE Main/Bennett Test',
        highlights: ['Modern Workshops', 'CAD/CAM Labs', 'Industry Tie-ups', 'EV Lab']
      },
      'B.Tech Biotechnology': {
        ...
        fees: '₹3,25,000/year',
        perSemesterFees: '₹1,66,500/semester',
        totalFees: '₹13,00,000 (Total for 4 years)',
        seats: 60,
        specializations: ['Biomedical Technologies', 'Drug Discovery', 'Genetic Counselling', 'Industrial Biotechnology', 'Nanotechnology & Biosensors'],
        entranceExam: 'Bennett Test',
        highlights: ['Modern Labs', 'Research Opportunities', 'Industry Training']
      },
      'MBA': {
        name: 'MBA (Master of Business Administration)',
        duration: '2 Years (4 Semesters)',
        eligibility: 'Bachelor\'s degree with minimum 50% marks. CAT/MAT/CMAT/GMAT qualified.',
        fees: '₹6,00,000/year',
        perSemesterFees: '₹3,07,500/semester',
        totalFees: '₹12,00,000 (Total for 2 years)',
        seats: 180,
        specializations: ['Sales & Marketing Management', 'Business Analytics & Operations', 'Human Resource Management', 'Finance Management', 'Media Management', 'Logistics & Supply Chain Management'],
        entranceExam: 'CAT/MAT/CMAT/GMAT/Bennett Test',
        highlights: ['Industry Focused Curriculum', 'Case Based Teaching', 'Global Exposure', '100% Placement Assistance']
      },
      'BCA': {
        name: 'Bachelor of Computer Applications',
        duration: '3/4 Years (6/8 Semesters)',
        eligibility: '10+2 with minimum 60% marks (Best of 3 subjects)',
        fees: '₹1,80,000/year',
        perSemesterFees: '₹92,500/semester',
        totalFees: '₹5,40,000 (Total for 3 years)',
        seats: 180,
        specializations: ['Cloud Computing', 'Cyber Security', 'Data Science', 'Artificial Intelligence', 'DevOps', 'Full Stack', 'Drones', 'Blockchain', 'Gaming', 'Mobile Technologies'],
      ...
      'BBA LL.B': {
        ...
        eligibility: '10+2 with minimum 60% marks. CLAT/Bennett Test qualified.',
        fees: '₹3,40,000/year',
        perSemesterFees: '₹1,74,500/semester',
        totalFees: '₹17,00,000 (Total for 5 years)',
        seats: 120,
        specializations: ['Corporate Law', 'Criminal Law', 'Constitutional Law', 'Human Rights'],
        entranceExam: 'CLAT/Bennett Test',
    ...
    topRecruiters: [
      ...
      'Zomato', 'Flipkart', 'Paytm', 'Byju\'s', 'Naukri.com'
    ],
    facilities: [
      'Smart Classrooms', 'NVIDIA AI Lab', 'Apple iMac Lab', 'Digital Library',
      ...
      'Gymnasium', 'Bank/ATM', 'Moot Court', 'TV Studio', 'Radio Studio',
      'Swimming Pool', 'Tennis Courts', 'Pickleball Courts', 'Padel Tennis Courts',
      'Football Ground', 'Cricket Ground', 'Basketball Courts', 'Squash Courts'
    ],
    contact: {
      phone: '1800-103-8484',
      email: 'admissions@bennett.edu.in',
      website: 'www.bennett.edu.in',
      tollFree: '1800-103-8484',
      helpline: '8860309257'
    },
    fees: '₹92,500 - ₹3,07,500/semester',
    reviews: 1250,
    description: 'Bennett University, established in 2016 under the aegis of The Times Group (186+ years legacy), is one of India\'s fastest-growing private universities. With a 68-acre sprawling campus, Bennett offers world-class education across Engineering, Management, Law, Media, Liberal Arts, and Design. The university features a NVIDIA DGX H100 Super Computer, Apple iOS Development Centre, Intel Center of Excellence, and has 300+ global partnerships with universities like Iowa State University, USA, and University of Birmingham, UK.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'Gaming', 'AR/VR',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'Operations',
      'Corporate Law', 'Criminal Law', 'Journalism', 'Digital Marketing', 'Film Production'
    ],
    brochure: '/brochures/bennett-university.pdf',
    achievements: [
      'Times Group Legacy (186+ Years)',
      'NAAC A Grade',
      'NIRF Ranked',
      'NVIDIA DGX H100 Super Computer',
      'Apple iOS Development Centre',
      'Intel Center of Excellence',
      '68-Acre Sprawling Campus',
      '300+ Global University Partnerships',
      '10+ International Campuses',
      'Bennett Hatchery (Startup Incubator)',
      'SIRO Recognition by DSIR',
      '4.85 Cr. Research Grants'
    ],
    alumniCount: '5,000+',
    facultyCount: '350+',
    globalPrograms: [
      '2+2 Program with Iowa State University, USA (Dual Degree)',
      'Semester Exchange Program with 300+ Global Universities',
      'International Study Tours (UK, USA, Australia, France)',
      'Study Abroad Programs (Summer/Winter Schools)',
      'Global Internship Opportunities',
      'Foreign Language Training (French, German, Japanese, Spanish)',
      'International Conferences & Seminars',
      'Collaboration with University of Birmingham, UK',
      'Partnership with Queen Mary University of London',
      'Collaboration with University of Technology Sydney'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at Bennett University?', answer: '10+2 with PCM with minimum 65% marks. JEE Main/Bennett Test score is also accepted.' },
      { question: 'What is the fee structure for B.Tech CSE?', answer: 'B.Tech CSE fee is ₹3,80,000 per year (₹1,94,000 per semester). Total fee for 4 years is approximately ₹15.2 Lakhs.' },
      { question: 'Does Bennett University have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC rooms. Hostel fees range from ₹1,70,000 to ₹2,25,000 per year.' },
      { question: 'What is the placement record of Bennett University?', answer: '85% placement record with highest package ₹44 LPA and average package ₹6.5 LPA. Top recruiters include Microsoft, Amazon, Google, Deloitte, KPMG.' },
      { question: 'Is Bennett University approved by UGC?', answer: 'Yes, Bennett University is UGC approved and NAAC A accredited.' },
      { question: 'What is the 2+2 Global Program?', answer: 'Bennett offers a 2+2 program with Iowa State University, USA. Students study 2 years at Bennett and 2 years at Iowa State, earning dual degrees.' },
      { question: 'Does Bennett University offer scholarship?', answer: 'Yes, merit-based scholarships up to 50% available based on 10+2 marks, JEE Main percentile, or CUET score.' },
      ...
      { question: 'What is the NVIDIA DGX H100 Super Computer?', answer: 'Bennett has a NVIDIA DGX H100 Super Computer for AI model building, training, and inferencing - one of the few universities in India to have this facility.' },
      { question: 'What is the Times Group legacy?', answer: 'Bennett University is established by The Times Group, India\'s largest media conglomerate with 186+ years of legacy, including The Times of India, The Economic Times, Radio Mirchi, and Times Now.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('Global')) return college.courseDetails['B.Tech CSE Global'];
    if (courseName.includes('Electronics')) return college.courseDetails['B.Tech ECE'];
    if (courseName.includes('Mechanical')) return college.courseDetails['B.Tech ME'];
    if (courseName.includes('Biotech')) return college.courseDetails['B.Tech Biotechnology'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Bennett University - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'NVIDIA AI Lab': Zap, 'Apple iMac Lab': Laptop,
    ...
    'Bank/ATM': Shield, 'Moot Court': BookOpen, 'TV Studio': Video, 'Radio Studio': Radio,
    'Swimming Pool': Waves, 'Tennis Courts': Award, 'Pickleball Courts': Building2,
    'Padel Tennis Courts': Building2, 'Football Ground': Building2, 'Cricket Ground': Building2,
    'Basketball Courts': Dumbbell, 'Squash Courts': Dumbbell
  };
  ...
  const mediaCourses = college.courses.filter(c => c.includes('Mass Communication') || c.includes('Film') || c.includes('TV'));
  const liberalCourses = college.courses.filter(c => c.includes('Liberal Arts'));
  const designCourses = college.courses.filter(c => c.includes('B.Des'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top University in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, BBA, BCA, LL.B). Times Group Legacy | NVIDIA Super Computer | 300+ Global Tie-ups. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-[70vh] min-h-[600px] w-full group">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 py-8 text-white">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              <div className="flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-full"><MapPin className="w-4 h-4" />TechZone II, Greater Noida</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">186+</div><div className="text-sm text-gray-500">Years Legacy</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,70,000 - ₹2,25,000/year. Scholarships available for meritorious students up to 50%. Bennett is established by The Times Group (186+ years legacy).</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ 2+2 Program with Iowa State University, USA (Dual Degree)</li><li>✓ Semester Exchange Program with 300+ Global Universities</li><li>✓ International Study Tours to UK, USA, Australia, France</li><li>✓ Study Abroad Programs (Summer/Winter Schools)</li><li>✓ Foreign Language Training (French, German, Japanese, Spanish)</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea123456789%3A0x123456789!2sBennett%20University!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Bennett University Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">UGC, AICTE, BCI, NCTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
