...
export function DronacharyaGroupPage() {
  ...
  const college = {
    ...
    fullName: 'Dronacharya Group of Institutions, Greater Noida',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'Advanced Computing Labs', 'iMac Lab', 'Research Center']
      },
      'B.Tech CSE AIML': {
      ...
      'B.Tech ECE': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Advanced Electronics Labs', 'PCB Design Lab', 'Robotics Lab', 'e-Yantra Lab']
      },
      'B.Tech ME': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Modern Workshops', 'CAD/CAM Labs', 'CNC Training Centre', 'BMW Twinpower Turbo Engine']
      },
      'MBA': {
    ...
    topRecruiters: [
      ...
      'DRDO', 'NIT Meghalaya', 'IIIT Delhi', 'IIT Guwahati', 'Bharat Petroleum', 'Indian Oil'
    ],
    facilities: [
      'Smart Classrooms', 'iMac Lab', 'Advanced Labs', 'Digital Library',
      'Hostel', 'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Incubation Center', 'Research Labs', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'e-Yantra Lab', 'Robotics Lab',
      'CNC Training Centre', 'ICT Academy', 'Spoken Tutorial Project Centre'
    ],
    contact: {
      phone: '0120-2322022',
      email: 'director@gnindia.dronacharya.info',
      website: 'www.gnindia.dronacharya.info',
      tollFree: '1800-123-4567',
      helpline: '9910380105'
    },
    fees: '₹89,700 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'Dronacharya Group of Institutions, established in 2006, is a premier technical institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow. With NAAC and NBA accreditations, Dronacharya is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features an iMac Lab, e-Yantra Lab sponsored by IIT Bombay, CNC Training Centre, and ICT Academy. Dronacharya has collaborations with IIT Bombay, IIT Kharagpur, NITTTR Chandigarh, and MSME for skill development.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'IoT',
      'Electronics & Communication', 'Mechanical Engineering', 'Electrical Engineering',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics'
    ],
    brochure: '/brochures/dronacharya-group.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      ...
      'MSME - Technology Development Center Collaboration',
      'Centre of Excellence for Smart Manufacturing (CoESM)',
      'Top 15 Security Researcher by NCIIPC India'
    ],
    alumniCount: '10,000+',
    facultyCount: '350+',
    globalPrograms: [
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at Dronacharya Group?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does Dronacharya have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of Dronacharya?', answer: '82% placement record with highest package ₹25 LPA and average package ₹4.8 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Amazon.' },
      { question: 'Is Dronacharya approved by AICTE?', answer: 'Yes, Dronacharya is approved by AICTE, NAAC accredited, and NBA accredited for multiple programs.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'Dronacharya offers B.Tech in CSE, CSE (AI & ML), CSE (Data Science), CSE (Cyber Security), CSE (IoT), ECE, ECS, CSIT, EEE, IT, and ME.' },
      { question: 'Does Dronacharya offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      { question: 'What is the iMac Lab at Dronacharya?', answer: 'Dronacharya has a state-of-the-art iMac Lab with latest gadgets supplied by Apple Inc., including iMacs, iPad, and Apple TV for hands-on learning.' },
      { question: 'What is the e-Yantra Lab?', answer: 'Dronacharya has an e-Yantra Lab sponsored by IIT Bombay with Fire Bird V Robotics Kit, SPARK V Robotics Kit, Kinect sensor, and KUKA robotics model.' },
      { question: 'What is the alumni network strength?', answer: 'Dronacharya has an alumni network of 10,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Dronacharya Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'iMac Lab': Laptop, 'Advanced Labs': Microscope,
    ...
    'Research Labs': Microscope, 'Cafeteria': Coffee, 'Transport Facility': Bus,
    'Medical Facility': Heart, 'Gymnasium': Dumbbell, 'Bank/ATM': Shield,
    'e-Yantra Lab': Zap, 'Robotics Lab': Microscope, 'CNC Training Centre': Car,
    'ICT Academy': Laptop, 'Spoken Tutorial Project Centre': Radio
  };
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA). NAAC | NBA | IIT Bombay Remote Center. Get free counseling for 2026 admissions!`} /></Helmet>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Dronacharya has iMac Lab, e-Yantra Lab sponsored by IIT Bombay, and CNC Training Centre with BMW Twinpower Turbo Engine.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Dronacharya Group Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
