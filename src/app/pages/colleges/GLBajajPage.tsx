...
export function GLBajajPage() {
  ...
  const college = {
    ...
    fullName: 'G.L. Bajaj Institute of Technology & Management, Greater Noida',
    ...
    accreditation: ['NBA', 'NAAC A', 'NIRF Rank 151', 'AICTE'],
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'NVIDIA AI Learning Centre', 'Advanced Computing Labs', 'Research Center']
      },
      'B.Tech CSE AIML': {
    ...
    placementRate: '90%',
    topRecruiters: [
      'Microsoft', 'Amazon', 'TCS', 'Wipro', 'Infosys', 'Cognizant', 'HCL',
      'Accenture', 'Tech Mahindra', 'Capgemini', 'Deloitte', 'KPMG', 'IBM',
      'Adobe', 'Samsung', 'Ericsson', 'ICICI Bank', 'HDFC Bank', 'Axis Bank',
      'Byju\'s', 'Paytm', 'Flipkart', 'Google'
    ],
    facilities: [
      'Smart Classrooms', 'NVIDIA AI Learning Centre', 'Advanced Labs', 'Research Center',
      'Digital Library', 'Hostel', 'Sports Complex', 'Wi-Fi Campus', 'Auditorium',
      'Incubation Center', 'Cafeteria', 'Transport Facility', 'Medical Facility',
      'Gymnasium', 'Bank/ATM', 'Mercedes-Benz ADAM Program Lab'
    ],
    contact: {
      phone: '0120-2323818',
      email: 'admission@glbitm.org',
      website: 'www.glbitm.org',
      tollFree: '1800-123-4567',
      helpline: '8750610005'
    },
    fees: '₹1,57,200/semester',
    reviews: 1250,
    description: 'G.L. Bajaj Institute of Technology & Management is one of the most sought-after engineering colleges in Greater Noida under AKTU, famous for its rigorous academics and outstanding placement packages. With NBA and NAAC A accreditation, GL Bajaj has a strong reputation for producing industry-ready engineers. The institute features an NVIDIA AI Learning Centre inaugurated by former ISRO Chairman Dr. K. Sivan and has collaborations with Microsoft, Amazon, and CISCO.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'IoT',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics'
    ],
    brochure: '/brochures/gl-bajaj.pdf',
    achievements: [
      'NBA Accreditation',
      'NAAC A Grade',
      'NIRF Rank 151',
      'NVIDIA AI Learning & Research Centre',
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at GL Bajaj?', answer: '10+2 with Physics, Chemistry, Mathematics with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does GL Bajaj have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of GL Bajaj?', answer: '90% placement record with highest package ₹44 LPA and average package ₹5.5 LPA. Top recruiters include Microsoft, Amazon, TCS, Wipro.' },
      { question: 'Is GL Bajaj approved by AICTE?', answer: 'Yes, GL Bajaj is approved by AICTE, NAAC A accredited, and NBA accredited for B.Tech programs.' },
      { question: 'What is the NIRF ranking of GL Bajaj?', answer: 'GL Bajaj is ranked 151 by NIRF in Engineering category.' },
      { question: 'Does GL Bajaj offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹60,000 available for students with good scores in entrance exams and academics.' },
      { question: 'What is the NVIDIA AI Learning Centre?', answer: 'GL Bajaj has an NVIDIA AI Learning & Research Centre inaugurated by former ISRO Chairman Dr. K. Sivan, powered by DGX A100.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'GL Bajaj has an alumni network of 8,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'GL Bajaj - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'NVIDIA AI Learning Centre': Zap, 'Advanced Labs': Laptop,
    'Research Center': Microscope, 'Digital Library': Library, 'Hostel': Home, 'Sports Complex': Dumbbell,
    'Wi-Fi Campus': Wifi, 'Auditorium': UsersRound, 'Incubation Center': Rocket, 'Cafeteria': Coffee,
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, MCA). NBA | NAAC A | NIRF Rank 151. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available for meritorious students. NVIDIA AI Learning Centre inaugurated by Dr. K. Sivan (former ISRO Chairman).</p></div>
                </div>
              )}
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NBA, NAAC A, AICTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
