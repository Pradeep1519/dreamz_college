...
export function GNGroupPage() {
  ...
  const college = {
    ...
    location: 'Knowledge Park II & III, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.3,
    students: '6,500+',
    type: 'Multi-Discipline',
    image: '/college-img/GNGroup/gnfront.jpg',
    gallery: [
      '/college-img/GNGroup/gn1.jpeg',
      '/college-img/GNGroup/gn2.jpeg',
      '/college-img/GNGroup/gn3.jpeg',
      '/college-img/GNGroup/gn4.jpeg'
    ],
    established: '2000',
    affiliation: 'AKTU, Lucknow | GGSIPU, Delhi | CCS University, Meerut | BTE, Lucknow',
    accreditation: ['AICTE', 'NBA', 'NAAC A+', 'PCI', 'BCI'],
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        seats: 180,
        specializations: ['Computer Science', 'Software Development', 'Algorithms', 'Programming Languages', 'Database Management'],
      ...
      'B.Tech CSE AI': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['AI Labs', 'Industry Projects', 'Research Opportunities']
      },
      'B.Tech CSE AI ML': {
        ...
        totalFees: '₹12,57,600 (Total for 4 years)',
        seats: 60,
        specializations: ['Machine Learning', 'Deep Learning', 'Data Science', 'Big Data Analytics', 'Python Programming'],
        entranceExam: 'JEE Main/UPSEE',
      ...
      'B.Tech CSE DS': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Data Science Specialization', 'Industry Certifications', 'Research Projects']
      },
      'MBA': {
        ...
        seats: 120,
        specializations: ['Marketing', 'Finance', 'Human Resource Management', 'International Business', 'Information Technology', 'Operations Management'],
      ...
      'PGDM': {
        ...
        seats: 60,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'Operations & Supply Chain'],
      ...
      'LL.B': {
        ...
        fees: '₹31,000/semester',
        perSemesterFees: '₹31,000/semester',
        totalFees: '₹1,86,000 (Total for 3 years)',
        seats: 120,
        specializations: ['Criminal Law', 'Corporate Law', 'Constitutional Law', 'Family Law', 'Intellectual Property Law'],
        entranceExam: 'CLAT/LSAT/Merit',
    ...
    placementRate: '90%',
    topRecruiters: [
      'Amazon', 'TCS', 'Microsoft', 'Google', 'Cipla', 'Deloitte', 
      'HDFC Bank', 'Wipro', 'Infosys', 'Samsung', 'HCL', 'Cognizant',
      'ICICI Bank', 'Axis Bank', 'Tech Mahindra', 'Capgemini', 'Sun Pharma'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Labs', 'Digital Library', 'Hostel', 
      'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Incubation Hub',
      'Research Center', 'Cafeteria', 'Transport Facility', 'Medical Facility',
      'Gymnasium', 'Bank/ATM', 'Moot Court', 'Herbal Garden'
    ],
    contact: {
      phone: '+91-7411003030',
      email: 'admissions@gngroup.org',
      website: 'www.gngroup.org',
      tollFree: '9882827474'
    },
    fees: '₹31,000 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'GN Group of Institutions is a premier educational group in Greater Noida offering diverse programs in Engineering, Management, Pharmacy, and Law. With state-of-the-art infrastructure, experienced faculty, and strong industry connections, the group has consistently delivered excellent academic results and placements since 2000.',
    specializations: [
    ...
    brochure: '/brochures/gn-group.pdf',
    achievements: [
      'NAAC A+ Grade',
      ...
      'AICTE Approved',
      'PCI Approved for Pharmacy',
      'BCI Approved for Law'
    ],
    alumniCount: '12,000+',
    facultyCount: '350+',
    globalPrograms: [
      ...
      'Foreign Language Training (French, German, Japanese, Chinese)',
      'International Conferences & Seminars',
      'Collaboration with International Universities'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at GN Group?', answer: 'Candidate must have passed 10+2 with Physics, Chemistry, and Mathematics with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      { question: 'What is the fee structure for B.Tech CSE?', answer: 'The fee for B.Tech CSE is ₹1,57,200 per semester. Total fee for 4 years is approximately ₹12.6 Lakhs.' },
      { question: 'Does GN Group provide hostel facilities?', answer: 'Yes, GN Group has separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of GN Group?', answer: 'GN Group has 90%+ placement record with top recruiters like Amazon, TCS, Microsoft, Deloitte, and HDFC Bank. Highest package is ₹14 LPA.' },
      { question: 'Is GN Group approved by AICTE?', answer: 'Yes, GN Group is approved by AICTE, and various programs are accredited by NBA and NAAC A+.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'GN Group offers B.Tech in CSE, AI, AI & ML, and Data Science specializations.' },
      { question: 'Does GN Group offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹60,000 are available for students with good scores in entrance exams and academics.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'GN Group has an alumni network of 12,000+ professionals working in top companies across India and abroad.' },
      { question: 'Does GN Group have multiple campuses?', answer: 'Yes, GN Group has multiple campuses in Knowledge Park II & III, Greater Noida for different disciplines.' }
    ]
  };

  // Auto-slide every 3 seconds
  useEffect(() => {
    if (!college.gallery || college.gallery.length <= 1) return;
  ...
  const getCurrentImage = () => {
    if (college.gallery && college.gallery.length > 0) {
      return college.gallery[currentImageIndex];
    }
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('AI') && courseName.includes('ML')) return college.courseDetails['B.Tech CSE AI ML'];
    if (courseName.includes('Artificial Intelligence') && !courseName.includes('ML')) return college.courseDetails['B.Tech CSE AI'];
    ...
    if (courseName.includes('LL.B')) return college.courseDetails['LL.B'];
    return null;
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'GN Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Labs': Laptop, 'Digital Library': Library, 'Hostel': Home,
    'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi, 'Auditorium': UsersRound, 'Incubation Hub': Rocket,
    'Research Center': Microscope, 'Cafeteria': Coffee, 'Transport Facility': Bus, 'Medical Facility': Heart,
    'Gymnasium': Dumbbell, 'Bank/ATM': Shield, 'Moot Court': BookOpen, 'Herbal Garden': Flower
  };

  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech'));
  const managementCourses = college.courses.filter(c => c.includes('MBA') || c.includes('PGDM') || c.includes('BBA'));
  const pharmacyCourses = college.courses.filter(c => c.includes('Pharm'));
  const lawCourses = college.courses.filter(c => c.includes('LL.B'));
  const commerceCourses = college.courses.filter(c => c.includes('B.Com') || c.includes('BCA'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered. Get free counseling for 2026 admissions!`} /></Helmet>

      <div className="min-h-screen bg-gray-50">
        {/* ========== HERO SECTION WITH AUTO-SLIDE ========== */}
        <div className="relative h-[65vh] min-h-[500px] w-full overflow-hidden">
          {/* Background Image - Clear & Sharp */}
          <div className="absolute inset-0">
            <img 
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1562774053-701939374585?w=1600&h=900&fit=crop';
              }}
            />
          ...
          <button
            ...
            className="absolute top-4 left-4 z-10 bg-black/40 hover:bg-black/60 text-white px-3 py-1.5 rounded-full text-xs flex items-center gap-1 transition-all duration-300 backdrop-blur-sm"
          >
          ...
          <div className="relative z-10 h-full flex flex-col justify-center max-w-7xl mx-auto px-6">
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <span className="px-3 py-1 bg-purple-600 rounded-full text-xs font-semibold text-white shadow-lg">
                {college.type}
              </span>
              {college.nirfRank && (
                <span className="px-3 py-1 bg-blue-600 rounded-full text-xs font-semibold text-white shadow-lg">
                  NIRF {college.nirfRank}
                </span>
              )}
              <span className="flex items-center gap-1 px-3 py-1 bg-yellow-500 rounded-full text-xs font-semibold text-white shadow-lg">
            ...
            <p className="text-white/90 text-sm md:text-base mb-4 max-w-2xl drop-shadow">
              {college.fullName}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-white/80">
              <div className="flex items-center gap-1">
                ...
                <span>Knowledge Park II & III, Greater Noida</span>
              </div>
              <div className="flex items-center gap-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  {commerceCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><Laptop className="w-5 h-5 text-purple-600" /> Commerce & IT Programs</h2><div className="space-y-4">{commerceCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span></div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}</div>)})}</div></div>)}
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available for meritorious students.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">AICTE, NBA, NAAC A+</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
