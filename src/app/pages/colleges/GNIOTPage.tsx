...
import { 
  ...
  Car, Building2, Waves, Radio, BookMarked, CircuitBoard,Database
} from 'lucide-react';
...
export function GNIOTGroupPage() {
  ...
  const college = {
    ...
    fullName: 'GNIOT Group of Institutions, Greater Noida',
    location: 'Plot No. 7, Knowledge Park II, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.1,
    students: '5,000+',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'Advanced Computing Labs', 'CISCO Network Academy', 'Oracle Academy']
      },
      'B.Tech CSE AIML': {
      ...
      'B.Tech ECE': {
        ...
        totalFees: '₹12,57,600 (Total for 4 years)',
        seats: 120,
        specializations: ['VLSI Design', 'Embedded Systems', 'IoT', 'Communication Systems', 'Robotics'],
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Advanced Electronics Labs', 'Robotics Lab', 'e-Yantra Lab', 'Microprocessor Lab']
      },
      'B.Tech Civil': {
      ...
      'B.Tech ME': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Modern Workshops', 'CAD/CAM Labs', 'CNC Training Centre', 'Industry Tie-ups']
      },
      'MBA': {
    ...
    facilities: [
      ...
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'Robotics Lab',
      'CISCO Network Academy', 'Oracle Academy', 'e-Yantra Lab'
    ],
    contact: {
      phone: '0120-2323818',
      email: 'info@gniot.net.in',
      website: 'www.gniot.net.in',
      tollFree: '1800-123-4567',
      helpline: '8750610005'
    },
    fees: '₹47,500 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'GNIOT Group of Institutions, established in 2007, is a premier technical institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow. With NAAC and NBA accreditations, GNIOT is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features advanced labs, CISCO Network Academy, Oracle Academy, e-Yantra Lab, and a dedicated Training & Placement Cell. GNIOT has collaborations with IIT Bombay, IIT Kharagpur, NITTTR Chandigarh, and MSME for skill development.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'IoT',
      'Electronics & Communication', 'Civil Engineering', 'Mechanical Engineering',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics'
    ],
    brochure: '/brochures/gniot-group.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      ...
      'Best Engineering College in Delhi-NCR Award'
    ],
    alumniCount: '8,000+',
    facultyCount: '300+',
    globalPrograms: [
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at GNIOT?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does GNIOT have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of GNIOT?', answer: '82% placement record with highest package ₹25 LPA and average package ₹4.8 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Amazon.' },
      { question: 'Is GNIOT approved by AICTE?', answer: 'Yes, GNIOT is approved by AICTE, NAAC accredited, and NBA accredited for multiple programs.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'GNIOT offers B.Tech in CSE, CSE (AI & ML), CSE (Data Science), CSE (Cyber Security), CSE (IoT), IT, ECE, Civil, ME, and Electrical.' },
      { question: 'Does GNIOT offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      { question: 'What is the CISCO Network Academy?', answer: 'GNIOT has a CISCO Network Academy for training students in networking and CCNA certification.' },
      { question: 'What is the e-Yantra Lab?', answer: 'GNIOT has an e-Yantra Lab sponsored by IIT Bombay for robotics and embedded systems training.' },
      { question: 'What is the alumni network strength?', answer: 'GNIOT has an alumni network of 8,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'GNIOT Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Bank/ATM': Shield, 'Robotics Lab': CircuitBoard, 'CISCO Network Academy': Wifi,
    'Oracle Academy': Database, 'e-Yantra Lab': Zap
  };
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, BCA). NAAC | NBA | CISCO Network Academy. Get free counseling for 2026 admissions!`} /></Helmet>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. GNIOT has CISCO Network Academy, Oracle Academy, and e-Yantra Lab sponsored by IIT Bombay.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="GNIOT Group Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
