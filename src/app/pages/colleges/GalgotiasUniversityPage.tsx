...
export function GalgotiasUniversityPage() {
  ...
  const college = {
    ...
    location: 'Yamuna Expressway, Greater Noida, Uttar Pradesh - 203201',
    rating: 4.2,
    students: '15,000+',
    ...
    established: '2011',
    affiliation: 'UGC, AICTE, PCI, BCI, NCTE',
    accreditation: ['NAAC A+', 'NBA', 'NIRF Rank 151-200', 'QS I-Gauge Platinum'],
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        eligibility: '10+2 with PCM with minimum 60% marks. JEE Main/UPSEE qualified.',
        fees: '₹1,69,000/year',
        perSemesterFees: '₹84,500/semester',
        totalFees: '₹6,76,000 (Total for 4 years)',
        seats: 360,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'IoT', 'Blockchain', 'Gaming Technology'],
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['NBA Accredited', 'Apple Authorized Training Centre', 'iOS Development Center', 'Intel Center of Excellence']
      },
      'B.Tech CSE AI ML': {
      ...
      'MBA': {
        ...
        fees: '₹1,69,000/year',
        perSemesterFees: '₹84,500/semester',
        totalFees: '₹3,38,000 (Total for 2 years)',
        seats: 180,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'International Business', 'Operations Management'],
      ...
      'BCA': {
        ...
        fees: '₹87,000/year',
        perSemesterFees: '₹43,500/semester',
        totalFees: '₹2,61,000 (Total for 3 years)',
        seats: 180,
      ...
      'LL.B': {
        ...
        fees: '₹75,000/year',
        perSemesterFees: '₹37,500/semester',
        totalFees: '₹2,25,000 (Total for 3 years)',
        seats: 180,
        specializations: ['Criminal Law', 'Corporate Law', 'Constitutional Law', 'Family Law'],
    ...
    placementRate: '85%',
    topRecruiters: [
      'Amazon', 'Microsoft', 'Adobe', 'Infosys', 'Accenture', 'TCS', 'Wipro',
      'Cognizant', 'HCL', 'Tech Mahindra', 'Capgemini', 'Deloitte', 'KPMG',
      'IBM', 'Google', 'Flipkart', 'Paytm', 'ICICI Bank', 'HDFC Bank',
      'Axis Bank', 'Byju\'s', 'Cipla', 'Sun Pharma'
    ],
    facilities: [
      'Smart Classrooms', 'Apple iMac Lab', 'iOS Development Center', 'Intel Center of Excellence',
      'NVIDIA AI Lab', 'Electric Vehicle Lab', 'Digital Library', 'Hostel', 'Sports Complex',
      'Wi-Fi Campus', 'Auditorium', 'Incubation Center', 'Research Labs', 'Cafeteria',
      'Transport Facility', 'Medical Facility', 'Gymnasium', 'Bank/ATM', 'Moot Court'
    ],
    contact: {
      phone: '0120-4370000',
      ...
      helpline: '0120-4806884'
    },
    fees: '₹43,500 - ₹1,69,000/year',
    reviews: 1250,
    description: 'Galgotias University is one of the largest private universities in North India, established in 2011. With NAAC A+ accreditation and NIRF ranking, the university offers over 200+ programs across Engineering, Management, Law, Pharmacy, and Design. Known for its vibrant campus life, 40+ student clubs, and strong industry connections, Galgotias has a 15,000+ student community from across India.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'Pharmaceutics',
      'Criminal Law', 'Corporate Law', 'Fashion Design', 'Interior Design'
    ],
    brochure: '/brochures/galgotias-university.pdf',
    achievements: [
      'NAAC A+ Grade',
      'NIRF Rank 151-200',
      'QS I-Gauge Platinum Rating',
      'Apple Authorized Training Centre',
      'iOS Developer Program with Apple & Infosys',
      'Intel Center of Excellence',
      '3rd Position in India for Patents Filed',
    ...
    globalPrograms: [
      ...
      'Partnership with GUVI (IIT-M & IIM-A incubated)'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at Galgotias University?', answer: '10+2 with Physics, Chemistry, and Mathematics with minimum 60% marks. JEE Main/UPSEE score is also accepted.' },
      { question: 'What is the fee structure for B.Tech CSE?', answer: 'B.Tech CSE fee is ₹1,69,000 per year (₹84,500 per semester). Total fee for 4 years is approximately ₹6.76 Lakhs.' },
      { question: 'Does Galgotias University have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,26,000 to ₹1,55,000 per year.' },
      { question: 'What is the placement record of Galgotias University?', answer: '85% placement record with highest package ₹39 LPA and average package ₹5.2 LPA. Top recruiters include Amazon, Microsoft, Adobe, and Infosys.' },
      { question: 'Is Galgotias University approved by UGC?', answer: 'Yes, Galgotias University is UGC approved and NAAC A+ accredited. NIRF Rank 151-200.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'Galgotias offers B.Tech in CSE, AI & ML, Data Science, Cyber Security, IoT, Cloud Computing, ECE, ME, Civil, EEE, Biotechnology, and Food Technology.' },
      { question: 'Does Galgotias University offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹60,000 available for students with good scores in entrance exams and academics.' },
      ...
      { question: 'What is the Apple iOS Development Center?', answer: 'Galgotias has an Apple Authorized Training Centre with iOS Developer Program in collaboration with Apple and Infosys.' },
      { question: 'What is the alumni network strength?', answer: 'Galgotias University has an alumni network of 20,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Galgotias University - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Apple iMac Lab': Laptop, 'iOS Development Center': Zap,
    'Intel Center of Excellence': Shield, 'NVIDIA AI Lab': Microscope, 'Electric Vehicle Lab': Car,
    ...
    'Bank/ATM': Shield, 'Moot Court': BookOpen
  };

  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech') && !c.includes('Biotech') && !c.includes('Food'));
  const managementCourses = college.courses.filter(c => c.includes('MBA') || c.includes('BBA'));
  const itCourses = college.courses.filter(c => c.includes('BCA') || c.includes('B.Com'));
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, B.Pharm, LL.B). NAAC A+ | NIRF Rank 151-200. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,26,000 - ₹1,55,000/year. Scholarships available for meritorious students.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ Collaboration with Nanyang Technological University, Singapore</li><li>✓ Partnership with GUVI (IIT-M & IIM-A incubated)</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai</li><li>✓ Foreign Language Training (French, German, Japanese, Chinese)</li></ul></div>
                </div>
              )}
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NAAC A+, UGC, AICTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
