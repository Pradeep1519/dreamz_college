...
import { 
  ...
  Car, Building2, Waves, Radio, BookMarked
} from 'lucide-react';
...
export function GlobalInstitutePage() {
  ...
  const college = {
    ...
    fullName: 'Global Institute of Information Technology, Greater Noida',
    location: '32A, Knowledge Park I, Greater Noida, Uttar Pradesh - 201310',
    rating: 4.0,
    students: '2,500+',
    ...
    established: '2002',
    affiliation: 'Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow | CCS University, Meerut',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'Advanced Computing Labs', 'Research Center', 'Industry Certifications']
      },
      'B.Tech CSE AIML': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['AI Specialization', 'Research Opportunities']
      },
      'B.Tech CSE DS': {
      ...
      'B.Tech ECE': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Advanced Electronics Labs', 'Microprocessor Lab', 'Digital Lab']
      },
      'MBA': {
        ...
        seats: 60,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Information Technology', 'International Trade', 'Operations Management'],
      ...
      'MCA': {
        ...
        seats: 60,
        specializations: ['AI & ML', 'Blockchain', 'IoT', 'Cyber Security', 'Data Analytics', 'Cloud Computing'],
        entranceExam: 'UPSEE',
      ...
      'B.Com': {
        ...
        eligibility: '10+2 with minimum 45% marks.',
        fees: '₹55,000/year',
        perSemesterFees: '₹27,500/semester',
        totalFees: '₹1,65,000 (Total for 3 years)',
        seats: 120,
        specializations: ['Accounting', 'Finance', 'Taxation', 'Banking & Insurance', 'Tally 9.0 ERP'],
        entranceExam: 'Merit Based',
      ...
      'B.A.': {
        ...
        eligibility: '10+2 with minimum 45% marks.',
        fees: '₹41,000/year',
        perSemesterFees: '₹20,500/semester',
        totalFees: '₹1,23,000 (Total for 3 years)',
        seats: 120,
        specializations: ['English', 'History', 'Political Science', 'Sociology', 'Economics', 'Psychology'],
        entranceExam: 'Merit Based',
        highlights: ['Competitive Exam Preparation', 'Co-curricular Activities', 'Certificate Course in Computer Fundamentals']
      },
      'B.Ed': {
        ...
        seats: 100,
        specializations: ['Teaching Methodology', 'Educational Psychology', 'Curriculum Design', 'Guidance & Counselling'],
        entranceExam: 'UPSEE',
    ...
    topRecruiters: [
      ...
      'Byju\'s', 'Naukri.com', 'Justdial', 'Genpact'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Computer Labs', 'Digital Library', 'Hostel',
      'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Communication Lab', 'Language Lab', 'Microprocessor Lab', 'Digital Lab',
      'Psychology Resource Centre', 'Science Lab', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'DELNET Membership'
    ],
    contact: {
      phone: '9350592987',
      email: 'info@globalinst.in',
      website: 'www.globalinst.in',
      tollFree: '1800-3090-801',
      helpline: '9350592988'
    },
    fees: '₹20,500 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'Global Institute of Information Technology, established in 2002, is a premier technical institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow and CCS University, Meerut. With NAAC and NBA accreditations, Global Institute is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features an iMac Lab, e-Yantra Lab, advanced computer labs, communication lab, and psychology resource centre. Global Institute has collaborations with IIT Bombay, IIT Kharagpur, NITTTR Chandigarh, and publishes three annual journals under "Anveshanam".',
    specializations: [
    ...
    brochure: '/brochures/global-institute.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      'ISO 9001:2015 Certified',
      'Remote Center of IIT Bombay for T10KT',
      'Remote Center of IIT Kharagpur',
      'Resource Center of IIT Bombay for Spoken Tutorial',
      'Active College for NPTEL Local Chapter of IIT Madras',
      'Publisher of "Anveshanam" Journal (3 annual journals)',
      'CSI Student Chapter',
      'Rank Awards for Top 10 University Students'
    ],
    alumniCount: '8,000+',
    facultyCount: '250+',
    globalPrograms: [
      ...
      'International Conference on Global Science, Technology, Education and Management (ICGSTEM)',
      'International Conference on Sustainable Practices in Technology, Management and Education (SPTME)'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at Global Institute?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does Global Institute have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of Global Institute?', answer: '80% placement record with highest package ₹25 LPA and average package ₹4.8 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Amazon.' },
      { question: 'Is Global Institute approved by AICTE?', answer: 'Yes, Global Institute is approved by AICTE, NAAC accredited, and NBA accredited for multiple programs.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'Global Institute offers B.Tech in CSE, CSE (AI & ML), CSE (Data Science), CSE (Cyber Security), CSE (IoT), IT, and ECE.' },
      { question: 'Does Global Institute offer scholarship?', answer: 'Yes, merit-based scholarships up to 25% for students scoring 85% and above in qualifying examination.' },
      { question: 'What is the Anveshanam Journal?', answer: 'Global Institute publishes three annual journals under "Anveshanam" in Computer Science, Management, and Education.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'Global Institute has an alumni network of 8,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('B.Com')) return college.courseDetails['B.Com'];
    if (courseName.includes('B.A.') && !courseName.includes('BBA')) return college.courseDetails['B.A.'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Global Institute - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Seminar Halls': UsersRound, 'Communication Lab': Radio, 'Language Lab': BookOpen,
    'Microprocessor Lab': Microscope, 'Digital Lab': Laptop, 'Psychology Resource Centre': BookMarked,
    'Science Lab': FlaskConical, 'Cafeteria': Coffee, 'Transport Facility': Bus,
    'Medical Facility': Heart, 'Gymnasium': Dumbbell, 'Bank/ATM': Shield, 'DELNET Membership': Library
  };
  ...
  const itCourses = college.courses.filter(c => c.includes('MCA') || c.includes('BCA'));
  const commerceCourses = college.courses.filter(c => c.includes('B.Com'));
  const artsCourses = college.courses.filter(c => c.includes('B.A.'));
  const educationCourses = college.courses.filter(c => c.includes('B.Ed'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top IT College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, BCA, BBA, B.Com, B.A., B.Ed). NAAC | NBA | IIT Bombay Remote Center. Get free counseling for 2026 admissions!`} /></Helmet>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  {artsCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><BookOpen className="w-5 h-5 text-purple-600" /> Arts Programs</h2><div className="space-y-4">{artsCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span></div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}</div>)})}</div></div>)}
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available for meritorious students up to 25%. Global Institute publishes "Anveshanam" journals in Computer Science, Management, and Education.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ International Conference on Global Science, Technology, Education and Management (ICGSTEM)</li><li>✓ International Conference on Sustainable Practices in Technology, Management and Education (SPTME)</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai</li><li>✓ Foreign Language Training (French, German, Japanese)</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Global Institute Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
