...
import { 
  ...
  Car, Building2, Waves, Radio, BookMarked, CircuitBoard, FlaskRound
} from 'lucide-react';
...
export function HIMTGroupPage() {
  ...
  const college = {
    ...
    fullName: 'HIMT Group of Institutions, Greater Noida',
    location: '8, Institutional Area, Knowledge Park I, Greater Noida, Uttar Pradesh - 201310',
    rating: 4.2,
    students: '5,000+',
    ...
    established: '1998',
    affiliation: 'Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow | CCS University, Meerut | UPBTE',
    ...
    courseDetails: {
      'MBA': {
        ...
        fees: '₹89,700/semester',
        perSemesterFees: '₹89,700/semester',
        totalFees: '₹3,58,800 (Total for 2 years)',
        seats: 120,
      ...
      'BBA': {
        ...
        highlights: ['Industry Exposure', 'Soft Skills Training', 'Internship Program', 'Tally Certification']
      },
      'BCA': {
        ...
        seats: 120,
        specializations: ['Web Development', 'Mobile App Development', 'Data Analytics', 'Cyber Security', 'Java Programming'],
        entranceExam: 'Merit Based',
      ...
      'MCA': {
        ...
        duration: '2 Years (4 Semesters)',
        eligibility: 'BCA/B.Sc (CS/IT) with minimum 50% marks. Mathematics at 10+2 or graduation level.',
        fees: '₹1,07,000/year',
        perSemesterFees: '₹53,500/semester',
        totalFees: '₹2,14,000 (Total for 2 years)',
        seats: 60,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing'],
        entranceExam: 'UPSEE',
        highlights: ['Programming Labs', 'Industry Certifications', 'Placement Support']
      },
      'B.Pharm': {
        ...
        entranceExam: 'UPSEE',
        highlights: ['PCI Approved', 'Modern Labs', 'Herbal Garden', 'Industry Training', 'Research Labs']
      },
      'B.Sc Biotech': {
        name: 'B.Sc Biotechnology',
        duration: '3 Years (6 Semesters)',
        eligibility: '10+2 with PCB with minimum 45% marks.',
        fees: '₹60,000/year',
        perSemesterFees: '₹30,000/semester',
        totalFees: '₹1,80,000 (Total for 3 years)',
        seats: 60,
        specializations: ['Genetic Engineering', 'Microbiology', 'Bioinformatics', 'Molecular Biology'],
        entranceExam: 'Merit Based',
        highlights: ['Advanced Labs', 'Research Opportunities', 'Industry Training']
      },
      'B.A. LL.B': {
      ...
      'B.Ed': {
        ...
        seats: 100,
        specializations: ['Teaching Methodology', 'Educational Psychology', 'Curriculum Design'],
        entranceExam: 'UPSEE',
        highlights: ['NCTE Approved', 'School Internship', 'Teaching Practice', 'Scouting & Guiding']
      }
    },
    ...
    topRecruiters: [
      ...
      'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'LG Electronics', 'Samsung',
      'Cipla', 'Sun Pharma', 'Apollo Hospitals', 'Fortis Healthcare', 'Byju\'s'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Labs', 'Digital Library', 'Hostel',
      ...
      'Language Lab', 'Psychology Lab', 'Science Lab', 'Computer Centre',
      'Pharmacy Labs', 'Biotechnology Labs', 'Herbal Garden'
    ],
    contact: {
      phone: '0120-2322880',
      email: 'info@himt.ac.in',
      website: 'www.himt.ac.in',
      tollFree: '1800-3090-801',
      helpline: '09310071455'
    },
    fees: '₹30,000 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'HIMT Group of Institutions, established in 1998, is a premier multi-disciplinary institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow, CCS University, Meerut, and UPBTE. With NAAC, NBA, PCI, BCI, and NCTE accreditations, HIMT is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features advanced labs, moot court, language lab, psychology lab, and a Centre of Excellence. HIMT has collaborations with IIT Bombay, IIT Kharagpur, and Microsoft, and publishes "The HIMT PARADIGM" magazine annually.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics',
      'Pharmaceutics', 'Pharmacology', 'Biotechnology',
      'Criminal Law', 'Corporate Law', 'Constitutional Law'
    ],
    brochure: '/brochures/himt-group.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      'PCI, BCI, NCTE Approvals',
      'ISO 9001:2015 Certified',
      'Remote Center of IIT Bombay for T10KT',
      'Resource Center of IIT Bombay for Spoken Tutorial',
      'Active College for NPTEL Local Chapter of IIT Madras',
      'Microsoft Academic Tie-up',
      'Centre of Excellence',
      'Best BCA Colleges Rank 21st in UP (IIRF 2025)',
      'Best BBA Colleges Rank 10th in UP (IIRF 2025)',
      'Rated AA+ by Careers 360',
      'Fastest Growing B-School Rank 1st in Greater Noida'
    ],
    alumniCount: '15,000+',
    facultyCount: '400+',
    globalPrograms: [
      ...
      'International Conference on Global Science, Technology, Education and Management'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at HIMT?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does HIMT have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of HIMT?', answer: '85% placement record with highest package ₹25 LPA and average package ₹4.8 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Amazon.' },
      { question: 'Is HIMT approved by AICTE?', answer: 'Yes, HIMT is approved by AICTE, NAAC accredited, and NBA accredited for multiple programs. Also approved by PCI, BCI, and NCTE.' },
      { question: 'What are the courses offered at HIMT?', answer: 'HIMT offers MBA, BBA, BCA, MCA, B.Tech, B.Pharm, D.Pharm, M.Pharm, B.Sc Biotech, M.Sc Biotech, B.A. LL.B, B.Com LL.B, LL.B, B.Ed, and D.El.Ed.' },
      { question: 'Does HIMT offer scholarship?', answer: 'Yes, merit-based scholarships up to 25% for students scoring 85% and above in qualifying examination.' },
      { question: 'What is the Centre of Excellence?', answer: 'HIMT has a Centre of Excellence for research and innovation, bringing together expertise and cutting-edge technology.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'HIMT has an alumni network of 15,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('MCA')) return college.courseDetails['MCA'];
    if (courseName.includes('B.Pharm')) return college.courseDetails['B.Pharm'];
    if (courseName.includes('Biotechnology')) return college.courseDetails['B.Sc Biotech'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'HIMT Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Labs': Laptop, 'Digital Library': Library,
    ...
    'Bank/ATM': Shield, 'Moot Court': BookOpen, 'Language Lab': Radio,
    'Psychology Lab': BookMarked, 'Science Lab': FlaskRound, 'Computer Centre': Laptop,
    'Pharmacy Labs': FlaskConical, 'Biotechnology Labs': Microscope, 'Herbal Garden': Flower
  };
  ...
  const biotechCourses = college.courses.filter(c => c.includes('Biotechnology'));
  const lawCourses = college.courses.filter(c => c.includes('LL.B'));
  const educationCourses = college.courses.filter(c => c.includes('B.Ed') || c.includes('D.El.Ed'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (MBA, B.Tech, B.Pharm, Law). NAAC | NBA | PCI | BCI. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">7+</div><div className="text-sm text-gray-500">Accreditations</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  {biotechCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><Microscope className="w-5 h-5 text-purple-600" /> Biotechnology Programs</h2><div className="space-y-4">{biotechCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span></div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}</div>)})}</div></div>)}
                  ...
                  {educationCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><GraduationCap className="w-5 h-5 text-purple-600" /> Education Programs</h2><div className="space-y-4">{educationCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span></div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}</div>)})}</div></div>)}
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. HIMT offers scholarships up to 25% for meritorious students. Rated AA+ by Careers 360.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ International Study Tours to Singapore, Malaysia, Dubai</li><li>✓ International Conference on Global Science, Technology, Education and Management</li><li>✓ Foreign Language Training (French, German, Japanese)</li><li>✓ Global Internship Opportunities</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="HIMT Group Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h2 className="text-xl font-semibold mb-4">Free Counseling</h2><div className="space-y-3 mb-6"><div className="flex justify-between p-3 bg-green-50 rounded-lg"><span>Application Fee</span><span className="font-bold text-green-600">FREE</span></div><div className="flex justify-between p-3 bg-blue-50 rounded-lg"><span>Last Date</span><span className="font-bold text-blue-600">30 June 2025</span></div><div className="flex justify-between p-3 bg-purple-50 rounded-lg"><span>Scholarship</span><span className="font-bold text-purple-600">Upto 25%</span></div></div><button onClick={()=>setShowEnquiryForm(true)} className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold shadow-lg">Apply Now (Free)</button><div className="mt-4 text-center"><p className="text-xs text-gray-500">✓ 100% Free | ✓ Expert Guidance | ✓ Quick Response</p></div></div>
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NAAC, NBA, PCI, BCI</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
