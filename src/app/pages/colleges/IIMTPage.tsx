...
import { 
  ...
  ShieldCheck, Award as AwardIcon, Laptop, Flower,Car,        // ← YEH BHI ADD KARO (agar use kiya hai)
  Radio,      // ← YEH ADD KARO
  Video,      // ← AGAR VIDEO USE KIYA HAI
  BookMarked, // ← AGAR BookMarked USE KIYA HAI
  CircuitBoard, // ← AGAR CircuitBoard USE KIYA HAI
  Gavel,      // ← AGAR Gavel USE KIYA HAI
  Stethoscope, // ← AGAR Stethoscope USE KIYA HAI
  Scale  
} from 'lucide-react';
...
export function IIMTGroupPage() {
  ...
  const college = {
    ...
    fullName: 'IIMT Group of Colleges, Greater Noida',
    ...
    established: '1994',
    affiliation: 'AKTU, Lucknow | CCS University, Meerut | BTE, Lucknow',
    accreditation: ['NAAC A', 'NBA', 'AICTE', 'PCI', 'BCI', 'NCTE'],
    ranking: 'Top Multi-Disciplinary',
    nirfRank: 'Top 200',
    courses: [
    ...
    placementRate: '82%',
    topRecruiters: [
      'TCS', 'Wipro', 'HCL', 'Infosys', 'Cognizant', 'Tech Mahindra', 'Accenture',
      'Capgemini', 'Deloitte', 'KPMG', 'IBM', 'Amazon', 'Flipkart', 'Paytm',
      'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'Cipla', 'Sun Pharma', 'Apollo Hospitals'
    ],
    facilities: [
      ...
      'IIMT Radio & News Channel', 'NCC Wing'
    ],
    contact: {
      phone: '0120-2322655',
      email: 'contact_gn@iimtindia.net',
      website: 'www.iimtindia.net',
      tollFree: '1800-123-4567',
      helpline: '09911009144'
    },
    fees: '₹48,000 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'IIMT Group of Colleges is one of the largest educational groups in the region, established in 1994 with 30 years of excellence. The group offers a vast array of courses from Engineering, Management, Pharmacy, Law, Education, and Journalism. With NAAC A accreditation and NBA accreditation for multiple programs, IIMT has a strong reputation for quality education, excellent placements, and a vibrant campus life.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'IoT',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics',
      'Pharmaceutics', 'Pharmacology', 'Criminal Law', 'Corporate Law'
    ],
    brochure: '/brochures/iimt-group.pdf',
    achievements: [
      '30 Years of Excellence (Est. 1994)',
      'NAAC A Grade',
      'NBA Accreditation',
      'Top Multi-Disciplinary Institute',
      'IIMT Radio & News Channel',
      'Research & Development Incubation Center',
      'Automatic Camouflage Gun at DEFEXPO-20',
    ...
    globalPrograms: [
      ...
      'Technical Tie-ups with Toyota Kirloskar Motors, CISCO, Google Developer Student Clubs',
      'Collaboration with Dassault Systems, PTC, Mastercam Inc.'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at IIMT?', answer: '10+2 with Physics, Chemistry, Mathematics with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does IIMT have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of IIMT?', answer: '82% placement record with highest package ₹32 LPA and average package ₹4.8 LPA. Top recruiters include TCS, Wipro, HCL, Infosys.' },
      { question: 'Is IIMT approved by AICTE?', answer: 'Yes, IIMT is approved by AICTE, NAAC A accredited, and NBA accredited for multiple programs.' },
      { question: 'What is the NIRF ranking of IIMT?', answer: 'IIMT is ranked in Top 200 by NIRF.' },
      { question: 'Does IIMT offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹60,000 available for students with good scores in entrance exams and academics. ₹3 Crore scholarships awarded annually.' },
      { question: 'What is the IIMT Radio & News Channel?', answer: 'IIMT has its own community radio and news channel where students are trained as RJs and reporters.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'IIMT has an alumni network of 12,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'IIMT Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Moot Court': BookOpen, 'Herbal Garden': Flower, 'IIMT Radio & News Channel': Radio,
    'NCC Wing': Shield
  };
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, B.Pharm, LL.B). NAAC A | 30 Years of Excellence. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. ₹3 Crore scholarships awarded annually. IIMT has 30 years of excellence since 1994.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ Technical Tie-ups with Toyota Kirloskar Motors, CISCO, Google Developer Student Clubs</li><li>✓ Collaboration with Dassault Systems, PTC, Mastercam Inc. (₹30 Cr setup)</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai</li><li>✓ Foreign Language Training (French, German, Japanese)</li></ul></div>
                </div>
              )}
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NAAC A, AICTE, NBA, PCI</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
