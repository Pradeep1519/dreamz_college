...
export function ITSEngineeringGreaterNoidaPage() {
  ...
  const college = {
    id: 'its-engineering-greater-noida',
    name: 'I.T.S Engineering College',
    fullName: 'I.T.S Engineering College, Greater Noida',
    location: '46, Knowledge Park III, Greater Noida, Uttar Pradesh - 201308',
    rating: 4.3,
    students: '3,500+',
    type: 'Engineering',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'Apple iOS Apps Development Centre', 'Syscom Innovation Development Centre', 'Software Testing Lab']
      },
      'B.Tech CSE AIML': {
      ...
      'B.Tech ECE': {
        ...
        totalFees: '₹12,57,600 (Total for 4 years)',
        seats: 120,
        specializations: ['VLSI Design', 'Embedded Systems', 'IoT', 'Communication Systems', 'Signal Processing'],
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Advanced Electronics Labs', 'PCB Design Lab', 'Robotics Lab', 'National Instruments Innovation Centre']
      },
      'B.Tech ME': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Modern Workshops', 'CAD/CAM Labs', 'SMC Pneumatics & Electro Pneumatics Excellence Centre']
      },
      'B.Tech Civil': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Surveying Lab', 'Material Testing Lab', 'CAD Lab', 'STAAD Pro']
      },
      'MBA': {
    ...
    topRecruiters: [
      ...
      'Ericsson', 'Samsung', 'LG Electronics', 'Syscom Corporation', 'NIT Technologies'
    ],
    facilities: [
      'Smart Classrooms', 'Apple iOS Apps Development Centre', 'Advanced Labs', 'Digital Library',
      'Hostel', 'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Incubation Center', 'Research Labs', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'National Instruments Innovation Centre',
      'SMC Pneumatics Excellence Centre', 'Rockwell Automation Centre', 'Software Testing Lab'
    ],
    contact: {
      phone: '0120-2331000',
      email: 'admissions.ec@its.edu.in',
      website: 'www.its.edu.in',
      tollFree: '1800-123-4567',
      helpline: '8510010843'
    },
    fees: '₹89,700 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'I.T.S Engineering College, established in 2006, is a premier engineering institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow. With NAAC and NBA accreditations, I.T.S is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features Apple iOS Apps Development Centre, Syscom Innovation Development Centre, National Instruments Innovation Centre, SMC Pneumatics Excellence Centre, Rockwell Automation Centre, and Software Testing Lab in collaboration with Indian Testing Board.',
    specializations: [
    ...
    brochure: '/brochures/its-engineering-greater-noida.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      'ISO 9001:2015 Certified',
      'Apple iOS Apps Development Centre',
      'Syscom Innovation Development Centre',
      'National Instruments Innovation Centre',
      'SMC Pneumatics Excellence Centre',
      'Rockwell Automation Centre',
      'Software Testing Lab (ISTQB Certified)',
      'Placement Excellence Award',
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at I.T.S Engineering College?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does I.T.S Engineering College have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of I.T.S Engineering College?', answer: '85% placement record with highest package ₹44 LPA and average package ₹5.2 LPA. Top recruiters include Microsoft, Amazon, Google, Deloitte, KPMG.' },
      { question: 'Is I.T.S Engineering College approved by AICTE?', answer: 'Yes, I.T.S Engineering College is approved by AICTE, NAAC accredited, and NBA accredited for multiple programs.' },
      { question: 'What is the Apple iOS Apps Development Centre?', answer: 'I.T.S has an Apple iOS Apps Development Centre where students learn iOS app development and get hands-on experience.' },
      { question: 'Does I.T.S Engineering College offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      ...
      { question: 'What are the Centers of Excellence at I.T.S?', answer: 'I.T.S has Apple iOS Apps Development Centre, National Instruments Innovation Centre, SMC Pneumatics Excellence Centre, Rockwell Automation Centre, and Software Testing Lab.' },
      { question: 'What is the alumni network strength?', answer: 'I.T.S Engineering College has an alumni network of 8,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('Civil')) return college.courseDetails['B.Tech Civil'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'I.T.S Engineering - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Apple iOS Apps Development Centre': Laptop,
    'Advanced Labs': Microscope, 'Digital Library': Library, 'Hostel': Home,
    'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi, 'Auditorium': UsersRound,
    'Seminar Halls': UsersRound, 'Incubation Center': Rocket, 'Research Labs': Microscope,
    'Cafeteria': Coffee, 'Transport Facility': Bus, 'Medical Facility': Heart,
    'Gymnasium': Dumbbell, 'Bank/ATM': Shield, 'National Instruments Innovation Centre': Zap,
    'SMC Pneumatics Excellence Centre': Car, 'Rockwell Automation Centre': CircuitBoard,
    'Software Testing Lab': Laptop
  };
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA). NAAC | NBA | Apple iOS Development Centre. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">5+</div><div className="text-sm text-gray-500">Centers of Excellence</div></div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. I.T.S has Apple iOS Apps Development Centre, National Instruments Innovation Centre, SMC Pneumatics Excellence Centre, and Rockwell Automation Centre.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="I.T.S Engineering College Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
