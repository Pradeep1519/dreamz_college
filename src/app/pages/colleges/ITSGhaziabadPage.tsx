...
export function ITSGhaziabadPage() {
  ...
  const college = {
    id: 'its-ghaziabad',
    name: 'Institute of Technology & Science, Ghaziabad',
    fullName: 'Institute of Technology & Science, Mohan Nagar, Ghaziabad',
    ...
    accreditation: ['AICTE', 'NAAC A+', 'NBA', 'ISO 9001:2015'],
    ranking: 'Top Engineering & Management Institute',
    nirfRank: 'Top 200',
    courses: [
    ...
    courseDetails: {
      ...
      'MCA': {
        ...
        seats: 60,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'Blockchain'],
        entranceExam: 'UPSEE',
        highlights: ['NBA Accredited', 'Programming Labs', 'Industry Certifications', 'Placement Support']
      },
      'B.Tech CSE': {
        ...
        highlights: ['NBA Accredited', 'Advanced Computing Labs', 'IoT Lab', 'Data Science Lab']
      },
      'B.Tech CSE AIML': {
    ...
    topRecruiters: [
      ...
      'Ericsson', 'Samsung', 'LG Electronics', 'NIT Technologies', 'Syscom Corporation'
    ],
    facilities: [
      ...
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'IoT Lab', 'Data Science Lab',
      'Robotics Lab', 'Language Lab', 'Communication Lab'
    ],
    contact: {
      phone: '0120-2811000',
    ...
    reviews: 1250,
    description: 'Institute of Technology & Science, Ghaziabad, established in 1995, is a premier institute affiliated to Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow. With NAAC A+ and NBA accreditations, I.T.S is known for its quality education, state-of-the-art infrastructure, and excellent placement record. The institute features advanced labs, IoT lab, Data Science lab, Robotics lab, and a dedicated Training & Placement Cell. I.T.S has collaborations with Microsoft, Cisco, and Oracle for value-added certifications.',
    specializations: [
    ...
    brochure: '/brochures/its-ghaziabad.pdf',
    achievements: [
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at I.T.S Ghaziabad?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does I.T.S Ghaziabad have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of I.T.S Ghaziabad?', answer: '85% placement record with highest package ₹44 LPA and average package ₹5.5 LPA. Top recruiters include Microsoft, Amazon, Google, Deloitte, KPMG.' },
      { question: 'Is I.T.S Ghaziabad approved by AICTE?', answer: 'Yes, I.T.S Ghaziabad is approved by AICTE, NAAC A+ accredited, and NBA accredited for multiple programs.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'I.T.S offers B.Tech in CSE, CSE (AI & ML), CSE (Data Science), CSE (Cyber Security), CSE (IoT), ECE, ME, Civil, and EEE.' },
      { question: 'Does I.T.S Ghaziabad offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      ...
      { question: 'What is the Microsoft Center of Excellence?', answer: 'I.T.S has a Microsoft Center of Excellence for training students in cloud computing, data science, and AI technologies.' },
      { question: 'What is the alumni network strength?', answer: 'I.T.S Ghaziabad has an alumni network of 10,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'I.T.S Ghaziabad - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Bank/ATM': Shield, 'IoT Lab': Zap, 'Data Science Lab': Laptop, 'Robotics Lab': Microscope,
    'Language Lab': BookOpen, 'Communication Lab': Radio
  };
  ...
  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top Engineering & Management College in Ghaziabad</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (MBA, MCA, B.Tech). NAAC A+ | NBA | Microsoft Center of Excellence. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">A+</div><div className="text-sm text-gray-500">NAAC Grade</div></div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. I.T.S offers Microsoft Center of Excellence, Cisco Networking Academy, and Oracle Academy certifications.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="I.T.S Ghaziabad Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
