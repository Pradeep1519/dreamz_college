...
export function ITSHealthSciencesPage() {
  ...
  const college = {
    id: 'its-health-sciences',
    name: 'I.T.S Institute of Health & Allied Sciences',
    fullName: 'I.T.S Institute of Health & Allied Sciences, Greater Noida',
    ...
    accreditation: ['AICTE', 'PCI', 'INC', 'NCTE', 'ISO 9001:2015'],
    ranking: 'Top Health Sciences Institute',
    nirfRank: 'Top 200',
    courses: [
    ...
    courseDetails: {
      'BPT': {
        ...
        seats: 60,
        specializations: ['Orthopedics', 'Neurology', 'Cardiopulmonary', 'Sports', 'Pediatrics', 'Geriatrics'],
      ...
      'B.Sc Nursing': {
        ...
        eligibility: '10+2 with PCB with minimum 50% marks. Age: 17 years.',
        fees: '₹1,27,000/year',
        ...
        entranceExam: 'Merit Based',
        highlights: ['INC Approved', 'Clinical Training in Multi-specialty Hospitals', 'Simulation Lab', 'Hospital Exposure']
      },
      'B.Pharm': {
        ...
        seats: 100,
        specializations: ['Pharmaceutics', 'Pharmacology', 'Pharmaceutical Chemistry', 'Pharmacognosy', 'Pharmaceutical Analysis'],
        entranceExam: 'UPSEE',
      ...
      'B.Sc Biotech': {
        ...
        seats: 60,
        specializations: ['Genetic Engineering', 'Microbiology', 'Bioinformatics', 'Molecular Biology', 'Industrial Biotechnology'],
        entranceExam: 'Merit Based',
      ...
      'B.Sc MLT': {
        ...
        eligibility: '10+2 with PCB with minimum 50% marks.',
        fees: '₹50,000/year',
        perSemesterFees: '₹25,000/semester',
        totalFees: '₹2,00,000 (Total for 4 years)',
        seats: 60,
        specializations: ['Clinical Biochemistry', 'Clinical Microbiology', 'Hematology', 'Pathology', 'Blood Banking'],
        entranceExam: 'Merit Based',
        highlights: ['Modern Labs', 'Clinical Training', 'Hospital Exposure', 'Quality Control Training']
      },
      'B.Sc OTT': {
        ...
        totalFees: '₹2,00,000 (Total for 4 years)',
        seats: 60,
        specializations: ['OT Management', 'Anesthesia Technology', 'Surgical Technology', 'Sterilization Techniques'],
        entranceExam: 'Merit Based',
        highlights: ['OT Simulation Lab', 'Clinical Training', 'Hospital Internship']
      },
      'B.Sc Radiology': {
        ...
        entranceExam: 'Merit Based',
        highlights: ['Modern Imaging Labs', 'Clinical Training', 'Hospital Internship']
      },
      'B.Sc Optometry': {
        name: 'B.Sc Optometry',
        duration: '3 Years (6 Semesters) + 1 Year Internship',
        ...
        totalFees: '₹2,00,000 (Total for 4 years)',
        seats: 60,
        specializations: ['Contact Lens', 'Low Vision', 'Pediatric Optometry', 'Geriatric Optometry', 'Vision Therapy'],
        entranceExam: 'Merit Based',
        highlights: ['Optometry Labs', 'Clinical Training', 'Eye Hospital Internship']
      }
    },
    ...
    placementRate: '85%',
    topRecruiters: [
      'Apollo Hospitals', 'Fortis Healthcare', 'Max Healthcare', 'Medanta', 'Artemis Hospitals',
    ...
    facilities: [
      ...
      'Physiotherapy Labs', 'Nursing Simulation Lab', 'Pharmacy Labs',
      'Biotechnology Labs', 'Medical Lab Technology Labs', 'Radiology Labs',
      'Optometry Labs', 'Herbal Garden', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM'
    ],
    contact: {
      phone: '0120-2331000',
      email: 'admissions.health@its.edu.in',
      website: 'www.its.edu.in',
      tollFree: '1800-123-4567',
      helpline: '8447753523'
    },
    fees: '₹25,000 - ₹1,29,000/year',
    reviews: 1250,
    description: 'I.T.S Institute of Health & Allied Sciences is a premier healthcare education institute established in 2006, offering quality education in Physiotherapy, Nursing, Pharmacy, Biotechnology, and Allied Health Sciences. With PCI, INC, and AICTE approvals, the institute is known for its state-of-the-art infrastructure, experienced faculty, and excellent clinical training. Students get hands-on experience at I.T.S Surya Hospital, a 100-bed multi-specialty hospital, and other leading healthcare institutions.',
    specializations: [
      'Physiotherapy', 'Nursing', 'Pharmacy', 'Biotechnology',
      'Medical Lab Technology', 'Operation Theatre Technology',
      'Radiology & Imaging', 'Optometry', 'Pharmaceutics', 'Pharmacology'
    ],
    brochure: '/brochures/its-health-sciences.pdf',
    achievements: [
      'PCI Approved',
      'INC Approved',
    ...
    globalPrograms: [
      ...
      'Collaboration with International Healthcare Institutions'
    ],
    faqs: [
      { question: 'What is the eligibility for BPT at I.T.S?', answer: '10+2 with PCB with minimum 50% marks. Age: 17 years.' },
      { question: 'What is the fee structure for B.Sc Nursing?', answer: 'B.Sc Nursing fee is ₹1,27,000 per year. Total fee for 4 years is approximately ₹5.08 Lakhs.' },
      { question: 'Does I.T.S have hostel facilities for health sciences students?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of I.T.S Health Sciences?', answer: '85% placement record with highest package ₹8 LPA and average package ₹3.5 LPA. Top recruiters include Apollo, Fortis, Max, Cipla, Sun Pharma.' },
      { question: 'Is I.T.S Health Sciences approved by PCI and INC?', answer: 'Yes, I.T.S is approved by PCI (Pharmacy Council of India) and INC (Indian Nursing Council).' },
      { question: 'What is the clinical training facility?', answer: 'Students get clinical training at I.T.S Surya Hospital, a 100-bed multi-specialty hospital, and other leading healthcare institutions.' },
      { question: 'Does I.T.S offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in qualifying examination.' },
      ...
      { question: 'What is the alumni network strength?', answer: 'I.T.S Health Sciences has an alumni network of 5,000+ professionals working in top healthcare institutions across India and abroad.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('Operation Theatre')) return college.courseDetails['B.Sc OTT'];
    if (courseName.includes('Radiology')) return college.courseDetails['B.Sc Radiology'];
    if (courseName.includes('Optometry')) return college.courseDetails['B.Sc Optometry'];
    return null;
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'I.T.S Health Sciences - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Labs': Microscope, 'Digital Library': Library,
    'Hostel': Home, 'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi, 'Auditorium': UsersRound,
    'Seminar Halls': UsersRound, 'Physiotherapy Labs': Activity, 'Nursing Simulation Lab': Stethoscope,
    'Pharmacy Labs': FlaskConical, 'Biotechnology Labs': Microscope, 'Medical Lab Technology Labs': Microscope,
    'Radiology Labs': Zap, 'Optometry Labs': Eye, 'Herbal Garden': Flower,
  ...
  const nursingCourses = college.courses.filter(c => c.includes('B.Sc Nursing'));
  ...
  const paramedicalCourses = college.courses.filter(c => c.includes('Medical Lab') || c.includes('Operation Theatre') || c.includes('Radiology') || c.includes('Optometry'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top Health Sciences College</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (BPT, B.Sc Nursing, B.Pharm, Allied Health Sciences). PCI | INC Approved. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  {paramedicalCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><Zap className="w-5 h-5 text-purple-600" /> Paramedical Programs</h2><div className="space-y-4">{paramedicalCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span></div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}</div>)})}</div></div>)}
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Students get clinical training at I.T.S Surya Hospital, a 100-bed multi-specialty hospital.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="I.T.S Health Sciences Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">PCI, INC, AICTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
