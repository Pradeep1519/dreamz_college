...
export function ITSMohanNagarPage() {
  ...
  const college = {
    id: 'its-mohan-nagar',
    name: 'I.T.S - U.G Institute, Mohan Nagar',
    fullName: 'Institute of Technology and Science, Mohan Nagar, Ghaziabad',
    ...
    courseDetails: {
      'BBA': {
        ...
        highlights: ['Industry Exposure', 'Soft Skills Training', 'Internship Program', 'Tally Certification', 'Digital Marketing Training']
      },
      'BCA': {
        ...
        seats: 360,
        specializations: ['Web Development', 'Mobile App Development', 'Data Analytics', 'Cyber Security', 'Java Programming', 'Python Programming'],
        entranceExam: 'Merit Based',
        highlights: ['Programming Labs', 'Industry Certifications', 'Project Based Learning', 'Cloud Computing Training']
      },
      'B.Com Hons': {
        name: 'Bachelor of Commerce (Hons)',
        duration: '3 Years (6 Semesters)',
        eligibility: '10+2 with Commerce/Mathematics with minimum 50% marks.',
        fees: '₹55,000/year',
      ...
      'BA JMC': {
        ...
        eligibility: '10+2 with minimum 45% marks.',
        fees: '₹77,000/year',
        perSemesterFees: '₹38,500/semester',
        totalFees: '₹2,31,000 (Total for 3 years)',
        seats: 120,
    ...
    facilities: [
      ...
      'Media Lab', 'TV Studio', 'Radio Studio', 'Language Lab',
      'Cafeteria', 'Transport Facility', 'Medical Facility', 'Gymnasium',
      'Bank/ATM', 'E-Learning Studios', 'Video Conferencing Facility'
    ],
    contact: {
      phone: '0120-2811000',
      email: 'itsmn@its.edu.in',
      website: 'www.its.edu.in',
      tollFree: '1800-123-4567',
      helpline: '8447744044'
    },
    fees: '₹27,500 - ₹84,000/semester',
    reviews: 1250,
    description: 'I.T.S - U.G Institute, established in 1995, is a premier undergraduate institute affiliated to CCS University, Meerut. With NAAC and NBA accreditations, I.T.S is known for its quality education in Management, IT, Commerce, and Journalism. The institute features state-of-the-art computer labs, media lab, TV studio, radio studio, and a dedicated Training & Placement Cell. I.T.S has collaborations with Microsoft, Google, Oracle, and BSE for value-added certifications.',
    specializations: [
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics',
      'Web Development', 'Data Science', 'Cyber Security', 'Cloud Computing',
      'Accounting', 'Taxation', 'Financial Markets',
      'Print Journalism', 'Broadcast Journalism', 'Digital Media'
    ],
    brochure: '/brochures/its-mohan-nagar.pdf',
    achievements: [
      'NAAC Accreditation',
      'NBA Accreditation',
      'ISO 9001:2015 Certified',
      'Best Private Under Graduate College in North India',
      'Best Institute for BBA & BCA by India Today',
      'Microsoft Center of Excellence',
      'Bombay Stock Exchange (BSE) Collaboration',
    ...
    faqs: [
      { question: 'What is the eligibility for BBA at I.T.S?', answer: '10+2 with minimum 45% marks. English as compulsory subject.' },
      { question: 'What is the fee structure for BCA?', answer: 'BCA fee is ₹47,500 per semester. Total fee for 3 years is approximately ₹2.85 Lakhs.' },
      { question: 'Does I.T.S have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of I.T.S?', answer: '85% placement record with highest package ₹12 LPA and average package ₹4.5 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Amazon.' },
      { question: 'Is I.T.S approved by AICTE?', answer: 'Yes, I.T.S is approved by AICTE, NAAC accredited, and NBA accredited.' },
      { question: 'What are the value-added certifications offered?', answer: 'I.T.S offers certifications in Cloud Computing, Data Science, Cyber Security, Digital Marketing, Banking & Insurance, and Office 365 with Microsoft, Google, and BSE.' },
      { question: 'Does I.T.S offer scholarship?', answer: 'Yes, merit-based scholarships up to 25% for students scoring 85% and above in qualifying examination.' },
      { question: 'What is the Microsoft Center of Excellence?', answer: 'I.T.S has a Microsoft Center of Excellence for training students in Office 365, Business Analytics, and HR Analytics.' },
      { question: 'What is the admission process for BA JMC?', answer: 'Admission to BA JMC is based on merit in 10+2. Minimum 45% marks required.' },
      { question: 'What is the alumni network strength?', answer: 'I.T.S has an alumni network of 8,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('Journalism') || courseName.includes('Mass Communication')) return college.courseDetails['BA JMC'];
    return null;
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'I.T.S Mohan Nagar - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Seminar Halls': UsersRound, 'Media Lab': Radio, 'TV Studio': Video, 'Radio Studio': Radio,
    'Language Lab': BookOpen, 'Cafeteria': Coffee, 'Transport Facility': Bus,
    'Medical Facility': Heart, 'Gymnasium': Dumbbell, 'Bank/ATM': Shield,
    'E-Learning Studios': Laptop, 'Video Conferencing Facility': Video
  };
  ...
  const mediaCourses = college.courses.filter(c => c.includes('Journalism') || c.includes('Mass Communication'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top UG College in Ghaziabad</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (BBA, BCA, B.Com, BA JMC). NAAC | NBA | Microsoft Center of Excellence. Get free counseling for 2026 admissions!`} /></Helmet>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. I.T.S offers free laptop to every student and value-added certifications with Microsoft, Google, and BSE.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea123456789%3A0x123456789!2sI.T.S%20Mohan%20Nagar!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="I.T.S Mohan Nagar Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
