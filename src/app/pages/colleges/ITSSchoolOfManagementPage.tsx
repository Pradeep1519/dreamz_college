...
import { 
  ...
  TrendingUp as TrendingUpIcon, Briefcase as BriefcaseIcon
} from 'lucide-react';
...
export function ITSSchoolOfManagementPage() {
  ...
  const college = {
    id: 'its-school-of-management',
    name: 'I.T.S School of Management',
    fullName: 'I.T.S School of Management, Mohan Nagar, Ghaziabad',
    location: 'Delhi-Meerut Road, Mohan Nagar, Ghaziabad, Uttar Pradesh - 201007',
    rating: 4.4,
    students: '2,000+',
    type: 'Management',
    ...
    accreditation: ['AICTE', 'NBA', 'NAAC', 'ISO 9001:2015', 'AIU Equivalent'],
    ...
    courseDetails: {
      'PGDM': {
        ...
        eligibility: 'Bachelor\'s degree with minimum 50% marks. Valid score in CAT/MAT/CMAT/XAT/ATMA.',
        fees: '₹5,75,000 (Total)',
        perSemesterFees: '₹1,43,750/semester',
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 180,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Operations', 'Business Analytics', 'International Business', 'Digital Marketing'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
      ...
      'PGDM IB': {
        ...
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 60,
        specializations: ['International Business', 'Global Marketing', 'International Finance', 'Export-Import Management'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
        highlights: ['AICTE Approved', 'Global Exposure', 'International Study Tours', 'Foreign Language Training']
      },
      'PGDM Marketing': {
        name: 'PGDM (Marketing Management)',
        duration: '2 Years (Full Time)',
        eligibility: 'Bachelor\'s degree with minimum 50% marks. Valid score in CAT/MAT/CMAT/XAT/ATMA.',
        fees: '₹5,75,000 (Total)',
        perSemesterFees: '₹1,43,750/semester',
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Digital Marketing', 'Brand Management', 'Sales Management', 'Consumer Behaviour', 'Marketing Analytics'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
        highlights: ['Google Certification', 'Digital Marketing Lab', 'Industry Projects']
      },
      'PGDM Finance': {
        ...
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Investment Banking', 'Corporate Finance', 'Financial Analytics', 'Risk Management', 'Wealth Management'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
        highlights: ['NSE Certification', 'Bloomberg Terminal', 'Financial Modeling Lab']
      },
      'PGDM HR': {
        ...
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Talent Acquisition', 'Performance Management', 'HR Analytics', 'Organizational Development', 'Employee Relations'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
        highlights: ['HR Analytics Lab', 'Industrial Visits', 'Placement Assistance']
      },
      'PGDM Operations': {
        name: 'PGDM (Operations Management)',
        duration: '2 Years (Full Time)',
        eligibility: 'Bachelor\'s degree with minimum 50% marks. Valid score in CAT/MAT/CMAT/XAT/ATMA.',
        fees: '₹5,75,000 (Total)',
        perSemesterFees: '₹1,43,750/semester',
        totalFees: '₹5,75,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Supply Chain Management', 'Logistics', 'Project Management', 'Quality Management', 'Lean Six Sigma'],
        entranceExam: 'CAT/MAT/CMAT/XAT/ATMA',
        highlights: ['Six Sigma Certification', 'Supply Chain Lab', 'Industry Projects']
      }
    },
    ...
    placementRate: '95%',
    topRecruiters: [
      'Deloitte', 'KPMG', 'EY', 'PwC', 'Accenture', 'McKinsey & Company', 'BCG',
      'Amazon', 'Flipkart', 'Google', 'Microsoft', 'Adobe',
      'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'Kotak Mahindra', 'Yes Bank',
      'TCS', 'Infosys', 'Wipro', 'HCL', 'Cognizant', 'Tech Mahindra',
      'ITC', 'HUL', 'P&G', 'Nestle', 'Coca-Cola', 'PepsiCo',
      'American Express', 'HSBC', 'Standard Chartered'
    ],
    facilities: [
      'Smart Classrooms', 'Case Study Lab', 'Digital Library', 'Hostel',
      'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Incubation Center', 'Research Labs', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'Bloomberg Terminal',
      'Financial Modeling Lab', 'Digital Marketing Lab', 'HR Analytics Lab',
      'Language Lab', 'Communication Lab'
    ],
    contact: {
      phone: '0120-2811000',
      email: 'admissions@its.edu.in',
      website: 'www.its.edu.in',
      tollFree: '1800-123-4567',
      helpline: '8447744044'
    },
    fees: '₹1,43,750/semester',
    reviews: 1250,
    description: 'I.T.S School of Management, established in 1995, is a premier B-School offering AICTE approved PGDM programs with NBA accreditation and AIU equivalence to MBA. Ranked among India\'s top B-Schools, I.T.S is known for its rigorous academics, industry-focused curriculum, and excellent placement record. The institute features state-of-the-art infrastructure, Bloomberg Terminal, Financial Modeling Lab, and strong industry connections with 500+ corporate partners.',
    specializations: [
    ...
    brochure: '/brochures/its-school-of-management.pdf',
    achievements: [
      'NBA Accreditation',
      'NAAC A Grade',
      'AIU Equivalence to MBA',
      'Top B-School in North India',
      'Best Placement Record',
      'ISO 9001:2015 Certified',
      'Bloomberg Terminal Facility',
    ...
    faqs: [
      { question: 'What is the eligibility for PGDM at I.T.S School of Management?', answer: 'Bachelor\'s degree with minimum 50% marks. Valid score in CAT/MAT/CMAT/XAT/ATMA is required.' },
      { question: 'What is the fee structure for PGDM?', answer: 'PGDM total fee is ₹5.75 Lakhs for 2 years (₹1,43,750 per semester).' },
      { question: 'Does I.T.S School of Management have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of I.T.S School of Management?', answer: '95% placement record with highest package ₹28 LPA and average package ₹7.5 LPA. Top recruiters include Deloitte, KPMG, EY, PwC, Accenture, Amazon.' },
      { question: 'Is PGDM equivalent to MBA?', answer: 'Yes, PGDM at I.T.S is equivalent to MBA as per AIU (Association of Indian Universities).' },
      { question: 'What are the specializations offered in PGDM?', answer: 'I.T.S offers PGDM in Marketing, Finance, HR, Operations, Business Analytics, International Business, and Digital Marketing.' },
      { question: 'Does I.T.S School of Management offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      { question: 'What is the admission process for PGDM?', answer: 'Admission is based on CAT/MAT/CMAT/XAT/ATMA scores followed by GD and PI. Minimum 50% in graduation required.' },
      { question: 'What is the Bloomberg Terminal facility?', answer: 'I.T.S has Bloomberg Terminal for real-time financial data, analytics, and trading simulations - a facility available in only top B-Schools.' },
      { question: 'What is the alumni network strength?', answer: 'I.T.S School of Management has an alumni network of 10,000+ professionals working in top companies across India and abroad.' }
    ]
  };

  const getCourseDetails = (courseName: string) => {
    if (courseName.includes('PGDM') && !courseName.includes('IB') && !courseName.includes('Marketing') && !courseName.includes('Financial') && !courseName.includes('Human') && !courseName.includes('Operations')) return college.courseDetails['PGDM'];
    if (courseName.includes('International Business')) return college.courseDetails['PGDM IB'];
    if (courseName.includes('Marketing')) return college.courseDetails['PGDM Marketing'];
    if (courseName.includes('Financial')) return college.courseDetails['PGDM Finance'];
    if (courseName.includes('Human')) return college.courseDetails['PGDM HR'];
    if (courseName.includes('Operations')) return college.courseDetails['PGDM Operations'];
    return null;
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'I.T.S School of Management - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Case Study Lab': BookOpen, 'Digital Library': Library,
    ...
    'Bank/ATM': Shield, 'Bloomberg Terminal': TrendingUpIcon, 'Financial Modeling Lab': Laptop,
    'Digital Marketing Lab': Zap, 'HR Analytics Lab': BriefcaseIcon, 'Language Lab': BookOpen,
    'Communication Lab': Radio
  };

  const pgdmCourses = college.courses.filter(c => c.includes('PGDM') && !c.includes('Ph.D') && !c.includes('Executive'));
  const mbaCourses = college.courses.filter(c => c.includes('MBA') && !c.includes('Executive'));
  const executiveCourses = college.courses.filter(c => c.includes('Executive'));
  const phdCourses = college.courses.filter(c => c.includes('Ph.D'));

  return (
    <>
      <Helmet><title>{college.name} - PGDM Fees, Placements, Ranking 2026 | Top B-School in Delhi NCR</title>
      <meta name="description" content={`${college.name} - Explore PGDM fees (${college.fees}), placement packages (${college.highestPackage}), specializations offered. NBA Accredited | AIU Equivalent to MBA. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-[70vh] min-h-[600px] w-full group">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 py-8 text-white">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              <div className="flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-full"><MapPin className="w-4 h-4" />Mohan Nagar, Ghaziabad</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">NBA</div><div className="text-sm text-gray-500">Accredited</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  {/* PGDM Programs */}
                  {pgdmCourses.length > 0 && (
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                      <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
                        <Briefcase className="w-5 h-5 text-purple-600" />
                        PGDM Programs (AICTE Approved | NBA Accredited)
                      </h2>
                      <div className="space-y-4">
                        {pgdmCourses.map((course, i) => {
                          const details = getCourseDetails(course);
                          return (
                            <div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30">
                              <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                                <h3 className="font-semibold text-gray-900">{course}</h3>
                                <div className="text-right">
                                  <span className="text-purple-600 font-bold block">{details?.perSemesterFees || details?.fees || 'Contact'}</span>
                                  {details?.totalFees && <span className="text-xs text-gray-500">({details.totalFees})</span>}
                                </div>
                              </div>
                              {details && (
                                <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                  <div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div>
                                  <div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div>
                                  <div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0, 50)}...</p></div>
                                  <div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div>
                                </div>
                              )}
                              {details?.specializations && (
                                <div className="mt-3 flex flex-wrap gap-2">
                                  {details.specializations.slice(0, 4).map((spec, j) => (
                                    <span key={j} className="px-2 py-1 bg-gray-100 text-gray-600 rounded-full text-xs">{spec}</span>
                                  ))}
                                </div>
                              )}
                            </div>
                  ...
                  {mbaCourses.length > 0 && (
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                      ...
                      <div className="space-y-4">
                        {mbaCourses.map((course, i) => (
                          <div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30">
                            <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
                              <h3 className="font-semibold text-gray-900">{course}</h3>
                              <div className="text-right">
                                <span className="text-purple-600 font-bold block">₹1,54,500/semester</span>
                              </div>
                            </div>
                            <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                              <div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">2 Years</p></div>
                              <div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">Bachelor's degree with 50% marks</p></div>
                              <div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">MAT/CAT/CMAT</p></div>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {executiveCourses.length > 0 && (
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                      ...
                      <div className="space-y-4">
                        {executiveCourses.map((course, i) => (
                          <div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30">
                            <h3 className="font-semibold text-gray-900">{course}</h3>
                            <p className="text-sm text-gray-600 mt-1">For working professionals with minimum 2 years of work experience. Weekend classes available.</p>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="bg-blue-50 rounded-xl p-4">
                    <p className="text-sm text-gray-600">
                      <span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available for meritorious students. PGDM is equivalent to MBA by AIU.
                    </p>
                  </div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="I.T.S School of Management Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NBA, AICTE, AIU</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
