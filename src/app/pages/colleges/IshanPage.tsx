...
import { 
  ...
  Stethoscope, Activity, Bone, Leaf, Flower2, Sun, Moon
} from 'lucide-react';
...
export function IshanEducationalPage() {
  ...
  const college = {
    ...
    name: 'Ishan Educational Institutions',
    fullName: 'Ishan Ayurvedic Medical College & Research Centre, Greater Noida',
    location: 'Knowledge Park II, Greater Noida, Uttar Pradesh - 201310',
    rating: 4.2,
    students: '2,500+',
    type: 'Ayurvedic Medical College',
    image: 'https://images.unsplash.com/photo-1581092335871-4c7e9b6435c2?w=800',
    gallery: [
    ...
    established: '1994',
    affiliation: 'Mahayogi Guru Gorakhnath AYUSH University, Uttar Pradesh | NCISM',
    accreditation: ['NCISM', 'Ministry of AYUSH', 'ISO 9001:2015'],
    ranking: 'Top Ayurvedic College',
    nirfRank: 'Top 50',
    courses: [
    ...
    courseDetails: {
      'BAMS': {
        ...
        fees: '₹2,80,000/year',
        perSemesterFees: '₹1,40,000/semester',
        totalFees: '₹15,40,000 (Total for 5.5 years)',
        seats: 100,
        specializations: ['Kayachikitsa', 'Shalya Tantra', 'Shalakya Tantra', 'Prasuti Tantra', 'Kaumarbhritya', 'Panchakarma', 'Dravyaguna', 'Rasashastra', 'Swasthavritta'],
        entranceExam: 'NEET UG',
        highlights: ['NCISM Approved', '100-bed Hospital', 'Herbal Garden with 1200+ Medicinal Plants', 'Panchakarma Facility', 'Advanced Research Centre']
      }
    },
    ...
    topRecruiters: [
      ...
      'Patanjali Ayurved', 'Dabur', 'Himalaya Wellness', 'Baidyanath',
      'Government Hospitals', 'Private Ayurvedic Clinics', 'Research Institutions',
      'AYUSH Departments', 'Ministry of AYUSH', 'WHO Collaborating Centres'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Laboratories', 'Digital Library', 'Hostel',
      'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Herbal Garden (1200+ Medicinal Plants)', 'Nakshatra Vatika', 'Panchakarma Wing',
      '100-bed Hospital', 'Operation Theatre', 'Pathology Lab', 'Radiology Lab',
      'ECG Unit', 'Physiotherapy Centre', 'Yoga Centre', 'Cafeteria',
      'Transport Facility', 'Medical Facility', 'Gymnasium', 'Bank/ATM',
      'Temple', 'Computer Lab', 'Research Centre'
    ],
    contact: {
      phone: '0120-2323818',
      email: 'info@ishanayurved.com',
      website: 'www.ishanayurved.com',
      tollFree: '1800-123-4567',
      helpline: '9910380105'
    },
    fees: '₹1,40,000/semester',
    reviews: 1250,
    description: 'Ishan Educational Institutions, established in 1994, is a premier Ayurvedic medical college offering BAMS program approved by NCISM and Ministry of AYUSH. The institute features a 100-bed teaching hospital, advanced Panchakarma facility, and a vast herbal garden with over 1200 medicinal plants. Ishan is known for its holistic approach to Ayurvedic education, combining traditional wisdom with modern medical practices. The college hosts international seminars like AYURMANTHAN 2023 with participants from 16 countries and publishes the "Ayurvedic Health Care Journal".',
    specializations: [
      'Kayachikitsa (Internal Medicine)', 'Shalya Tantra (Surgery)', 'Shalakya Tantra (ENT & Ophthalmology)',
      'Prasuti Tantra (Gynecology & Obstetrics)', 'Kaumarbhritya (Pediatrics)', 'Panchakarma',
      'Dravyaguna (Pharmacology)', 'Rasashastra (Pharmaceuticals)', 'Swasthavritta (Preventive Medicine)'
    ],
    brochure: '/brochures/ishan-educational.pdf',
    achievements: [
      'NCISM Approved',
      'Ministry of AYUSH Recognized',
      'ISO 9001:2015 Certified',
      'International Seminar AYURMANTHAN 2023 with 16 Countries',
      'Advanced Research Centre',
      'Herbal Garden with 1200+ Medicinal Plants',
      'Nakshatra Vatika (Astrological Garden)',
      '36 Books Published on Ayurveda',
      'Bi-annual Research Journal "Ayurvedic Health Care Journal"',
      'Winner of Multiple Research Awards'
    ],
    alumniCount: '5,000+',
    facultyCount: '150+',
    globalPrograms: [
      'International Seminar AYURMANTHAN',
      'Global Collaborations for Ayurvedic Research',
      'International Conferences & Workshops',
      'Global Internship Opportunities',
      'International Study Tours'
    ],
    faqs: [
      { question: 'What is the eligibility for BAMS at Ishan?', answer: '10+2 with PCB with minimum 50% marks. NEET UG qualified as per NCISM norms.' },
      { question: 'What is the fee structure for BAMS?', answer: 'BAMS fee is ₹2,80,000 per year. Total fee for 5.5 years is approximately ₹15.4 Lakhs.' },
      { question: 'Does Ishan have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of Ishan?', answer: '85% placement record with highest package ₹12 LPA and average package ₹4.5 LPA. Graduates work in hospitals, research, and pharmaceutical companies.' },
      { question: 'Is Ishan approved by NCISM?', answer: 'Yes, Ishan is approved by NCISM (National Commission for Indian System of Medicine) and Ministry of AYUSH.' },
      { question: 'What are the clinical facilities available?', answer: 'Ishan has a 100-bed teaching hospital with OPD, IPD, Panchakarma wing, Operation Theatre, Pathology Lab, Radiology Lab, and ECG Unit.' },
      { question: 'Does Ishan offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good NEET scores.' },
      { question: 'What is the Herbal Garden at Ishan?', answer: 'Ishan has a vast Herbal Garden with over 1200 medicinal plants and a Nakshatra Vatika with 27 trees associated with lunar mansions.' },
      { question: 'What is AYURMANTHAN?', answer: 'AYURMANTHAN is an international seminar hosted by Ishan with participants from 16 countries focusing on Ayurvedic research and innovations.' },
      { question: 'What is the alumni network strength?', answer: 'Ishan has an alumni network of 5,000+ Ayurvedic professionals working across India and abroad.' }
    ]
  };

  const getCourseDetails = (courseName: string) => {
    if (courseName.includes('BAMS')) return college.courseDetails['BAMS'];
    return null;
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Ishan Educational - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Seminar Halls': UsersRound, 'Herbal Garden (1200+ Medicinal Plants)': Flower2,
    'Nakshatra Vatika': Sun, 'Panchakarma Wing': Activity, '100-bed Hospital': Building2,
    'Operation Theatre': Stethoscope, 'Pathology Lab': Microscope, 'Radiology Lab': Zap,
    'ECG Unit': Heart, 'Physiotherapy Centre': Activity, 'Yoga Centre': Sun,
    'Cafeteria': Coffee, 'Transport Facility': Bus, 'Medical Facility': Heart, 'Gymnasium': Dumbbell,
    'Bank/ATM': Shield, 'Temple': Building2, 'Computer Lab': Laptop, 'Research Centre': Microscope
  };

  return (
    <>
      <Helmet><title>{college.name} - BAMS Fees, Placements, Ranking 2026 | Top Ayurvedic College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore BAMS fees (${college.fees}), placement packages (${college.highestPackage}), clinical facilities. NCISM Approved | 100-bed Hospital | Herbal Garden. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-[70vh] min-h-[600px] w-full group">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 py-8 text-white">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              <div className="flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-full"><MapPin className="w-4 h-4" />Knowledge Park II, Greater Noida</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">1200+</div><div className="text-sm text-gray-500">Medicinal Plants</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ International Seminar AYURMANTHAN with 16 Countries</li><li>✓ Global Collaborations for Ayurvedic Research</li><li>✓ International Conferences & Workshops</li><li>✓ Global Internship Opportunities</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjnCsDMwJzAzLjYiTiA3N8KwMjknMzQuNyJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Ishan Educational Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NCISM, Ministry of AYUSH</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
