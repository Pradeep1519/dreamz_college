...
import { 
  ...
  ShieldCheck, Award as AwardIcon, Laptop, Flower, Car
} from 'lucide-react';
...
export function LloydInstitutePage() {
  ...
  const college = {
    ...
    fullName: 'Lloyd Institute of Engineering & Technology, Greater Noida',
    location: 'Knowledge Park II, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.0,
    students: '2,500+',
    type: 'Engineering',
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        fees: '₹2,45,000 - ₹9,46,000/year',
        perSemesterFees: '₹1,22,500 - ₹4,73,000/semester',
        totalFees: '₹9,80,000 - ₹37,84,000 (Total for 4 years)',
        seats: 120,
      ...
      'B.Tech ME': {
        ...
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Modern Workshops', 'CAD/CAM Labs', 'Industry Tie-ups']
      },
      'MBA': {
        name: 'MBA (Master of Business Administration)',
        duration: '2 Years (4 Semesters)',
        eligibility: 'Bachelor\'s degree with minimum 50% marks. MAT/CAT/CMAT qualified.',
        fees: '₹2,80,000 - ₹3,50,000/year',
        perSemesterFees: '₹1,40,000 - ₹1,75,000/semester',
        totalFees: '₹5,60,000 - ₹7,00,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics'],
      ...
      'MCA': {
        ...
        fees: '₹1,80,000 - ₹2,50,000/year',
        perSemesterFees: '₹90,000 - ₹1,25,000/semester',
        totalFees: '₹3,60,000 - ₹5,00,000 (Total for 2 years)',
        seats: 60,
    ...
    placementRate: '80%',
    topRecruiters: [
      'TCS', 'Wipro', 'Infosys', 'HCL', 'Cognizant', 'Capgemini', 'Accenture',
      'Tech Mahindra', 'Deloitte', 'KPMG', 'IBM', 'Amazon', 'Flipkart', 'Paytm',
      'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'LG Electronics', 'Samsung'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Labs', 'Digital Library', 'Hostel',
      'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Incubation Center',
      'Research Labs', 'Cafeteria', 'Transport Facility', 'Medical Facility',
      'Gymnasium', 'Bank/ATM', 'Robotics Lab', 'Drone Technology Lab',
      'Lloyd Technology & Business Incubator', 'Lloyd Skills Centre'
    ],
    contact: {
      phone: '0120-1234567',
      email: 'admissions@lloydinstitute.org',
      website: 'www.lloydinstitute.org',
      tollFree: '1800-123-4567',
      helpline: '8010500700'
    },
    fees: '₹2,45,000 - ₹9,46,000/year',
    reviews: 1250,
    description: 'Lloyd Institute of Engineering & Technology is a premier engineering institute established in 2008. With NBA accreditation and NAAC accreditation, Lloyd is known for its quality education, practical learning approach, and strong industry connections. The institute features a Technology Business Incubator with a ₹2.5 Crore grant from StartInUP, Lloyd Skills Centre, and specialized labs for Drone Technology, AI, and Robotics. Lloyd has partnerships with Nasscom, Servotech, CISCO, Garuda Aerospace, and MSME.',
    specializations: [
    ...
    brochure: '/brochures/lloyd.pdf',
    achievements: [
      'NBA Accreditation',
      'NAAC Accreditation',
      '₹2.5 Crore Grant from StartInUP',
      'Lloyd Technology & Business Incubator',
      'Lloyd Skills Centre',
      'Industry Partnerships with Nasscom, Servotech, CISCO, Garuda Aerospace',
      'Mercedes-Benz ADAM Program',
      'Winner of Inventor Challenge 2024'
    ],
    alumniCount: '5,000+',
    facultyCount: '200+',
    globalPrograms: [
    ...
    faqs: [
      { question: 'What is the eligibility for B.Tech at Lloyd Institute?', answer: '10+2 with Physics, Chemistry, Mathematics with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      { question: 'What is the fee structure for B.Tech CSE?', answer: 'B.Tech CSE fee ranges from ₹2,45,000 to ₹9,46,000 per year depending on specialization.' },
      { question: 'Does Lloyd Institute have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of Lloyd Institute?', answer: '80% placement record with highest package ₹28 LPA and average package ₹4.5 LPA. Top recruiters include TCS, Wipro, Infosys, HCL.' },
      { question: 'Is Lloyd Institute approved by AICTE?', answer: 'Yes, Lloyd Institute is approved by AICTE, NAAC accredited, and NBA accredited for B.Tech programs.' },
      { question: 'What is the Lloyd Technology & Business Incubator?', answer: 'Lloyd has a Technology Business Incubator with a ₹2.5 Crore grant from StartInUP for startups in Drones, EV, AI, Robotics.' },
      { question: 'Does Lloyd Institute offer scholarship?', answer: 'Yes, merit-based scholarships available for students with good scores in entrance exams and academics.' },
      ...
      { question: 'What is the Lloyd Skills Centre?', answer: 'Lloyd Skills Centre is a dedicated facility for skill development and training to enhance employability of students.' },
      { question: 'What is the alumni network strength?', answer: 'Lloyd Institute has an alumni network of 5,000+ professionals working in top companies across India and abroad.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Lloyd Institute - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    ...
    'Incubation Center': Rocket, 'Research Labs': Microscope, 'Cafeteria': Coffee,
    'Transport Facility': Bus, 'Medical Facility': Heart, 'Gymnasium': Dumbbell, 'Bank/ATM': Shield,
    'Robotics Lab': Microscope, 'Drone Technology Lab': Zap,
    'Lloyd Technology & Business Incubator': Rocket, 'Lloyd Skills Centre': GraduationCap
  };

  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech'));
  const managementCourses = college.courses.filter(c => c.includes('MBA'));
  const itCourses = college.courses.filter(c => c.includes('MCA'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top Engineering College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, MCA). NBA | NAAC | ₹2.5 Cr StartInUP Grant. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">₹2.5 Cr</div><div className="text-sm text-gray-500">StartInUP Grant</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NBA, NAAC, AICTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
