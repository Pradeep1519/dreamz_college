...
export function NIETPage() {
  ...
  const college = {
    ...
    fullName: 'Noida Institute of Engineering & Technology, Greater Noida',
    ...
    accreditation: ['NAAC A+', 'NBA', 'NIRF Rank 42 (Pharmacy)', 'NIRF Rank 101-150 (Engineering)', 'QS I-Gauge'],
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        seats: 180,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'IoT', 'Cloud Computing', 'Blockchain'],
      ...
      'B.Pharm': {
        ...
        entranceExam: 'UPSEE',
        highlights: ['PCI Approved', 'NIRF Rank 42', 'Modern Labs', 'Industry Training']
      },
      'MBA': {
        ...
        seats: 120,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'International Business'],
      ...
      'MCA': {
        ...
        entranceExam: 'UPSEE',
        highlights: ['NBA Accredited', 'Programming Labs', 'Industry Certifications']
      }
    },
    ...
    placementRate: '92%',
    topRecruiters: [
      'Google', 'Microsoft', 'Amazon', 'TCS', 'Wipro', 'Infosys', 'HCL', 'Cognizant',
      'Cipla', 'Sun Pharma', 'Deloitte', 'KPMG', 'Accenture', 'Tech Mahindra',
      'Capgemini', 'IBM', 'Adobe', 'Samsung', 'Ericsson', 'ICICI Bank', 'HDFC Bank'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Labs', 'Research Center', 'Digital Library',
      'Hostel', 'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Incubation Center',
      'NVIDIA AI Lab', 'Robotics Lab', 'Cafeteria', 'Transport Facility',
      'Medical Facility', 'Gymnasium', 'Bank/ATM', 'Mercedes-Benz ADAM Program Lab'
    ],
    contact: {
      phone: '0120-1234567',
      email: 'admissions@niet.co.in',
      website: 'www.niet.co.in',
      tollFree: '1800-123-4567',
      helpline: '8010500700'
    },
    fees: '₹53,500 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'NIET is a premier autonomous institute under AKTU, recognized as the first private institute in UP to get autonomous status by UGC. With NAAC A+ accreditation and NIRF ranking 101-150 in Engineering and 42 in Pharmacy, NIET is known for its excellent placement record, strong industry tie-ups, and state-of-the-art infrastructure. The institute has 110+ startups incubated and collaborations with Mercedes-Benz, Oracle, and CISCO.',
    specializations: [
    ...
    brochure: '/brochures/niet.pdf',
    achievements: [
      'First Private Institute in UP with Autonomous Status',
      'NAAC A+ Grade',
      'NIRF Rank 42 in Pharmacy',
      'NIRF Rank 101-150 in Engineering',
      '110+ Startups Incubated',
    ...
    facultyCount: '450+',
    globalPrograms: [
      'Twinning Program with James Cook University, Singapore',
      'Twinning Program with Management & Science University, Malaysia',
      'Semester Exchange Program with 15+ International Universities',
      'International Study Tours to Singapore, Malaysia, Dubai',
      'Foreign Language Training (French, German, Japanese)',
      'International Conferences & Seminars'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at NIET?', answer: '10+2 with Physics, Chemistry, Mathematics with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does NIET have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of NIET?', answer: '92% placement record with highest package ₹47 LPA and average package ₹6.2 LPA. Top recruiters include Google, Microsoft, Amazon, TCS.' },
      { question: 'Is NIET approved by AICTE?', answer: 'Yes, NIET is approved by AICTE, NAAC A+ accredited, and NBA accredited for multiple programs.' },
      { question: 'What is the NIRF ranking of NIET?', answer: 'NIET is ranked 101-150 in Engineering and 42 in Pharmacy by NIRF.' },
      { question: 'Does NIET offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹60,000 available for students with good scores in entrance exams and academics.' },
      { question: 'What is the Twinning Program at NIET?', answer: 'NIET offers Twinning Programs with James Cook University (Singapore) and Management & Science University (Malaysia) where students can complete part of their degree abroad.' },
      { question: 'What is the Mercedes-Benz ADAM Program?', answer: 'NIET has a Mercedes-Benz ADAM (Advanced Diploma in Automotive Mechatronics) program for hands-on training in automotive technology.' },
      { question: 'What is the startup ecosystem at NIET?', answer: 'NIET has incubated 110+ startups with support from MSME, Government of India, and has a dedicated Technology Business Incubator.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'NIET - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Labs': Laptop, 'Research Center': Microscope,
    'Digital Library': Library, 'Hostel': Home, 'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi,
    'Auditorium': UsersRound, 'Incubation Center': Rocket, 'NVIDIA AI Lab': Zap,
    'Robotics Lab': Microscope, 'Cafeteria': Coffee, 'Transport Facility': Bus,
    'Medical Facility': Heart, 'Gymnasium': Dumbbell, 'Bank/ATM': Shield,
    'Mercedes-Benz ADAM Program Lab': Car
  };
  ...
  const itCourses = college.courses.filter(c => c.includes('MCA') || c.includes('BCA') || c.includes('PGDM'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top Engineering College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, B.Pharm, MCA). NAAC A+ | NIRF Rank 101-150. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available for meritorious students. NIET is the first private institute in UP with Autonomous Status.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ Twinning Program with James Cook University, Singapore</li><li>✓ Twinning Program with Management & Science University, Malaysia</li><li>✓ Semester Exchange Program with 15+ International Universities</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai</li></ul></div>
                </div>
              )}
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NAAC A+, UGC, AICTE, NBA</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
