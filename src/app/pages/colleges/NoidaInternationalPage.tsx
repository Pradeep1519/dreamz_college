...
export function NoidaInternationalUniversityPage() {
  ...
  const college = {
    ...
    fullName: 'Noida International University (NIU), Greater Noida',
    location: 'Plot No. 1, Sector-17A, Yamuna Expressway, Gautam Buddha Nagar, Greater Noida, Uttar Pradesh - 203201',
    rating: 4.2,
    students: '8,000+',
    ...
    established: '2010',
    affiliation: 'UGC, NMC, INC, PCI, BCI, AICTE',
    accreditation: ['UGC', 'NAAC', 'NMC', 'INC', 'PCI', 'BCI', 'AICTE', 'ISO 9001:2015'],
    ...
    courseDetails: {
      'MBBS': {
        ...
        fees: '₹12,00,000/year',
        perSemesterFees: '₹6,00,000/semester',
        totalFees: '₹66,00,000 (Total for 5.5 years)',
        seats: 150,
        specializations: ['Medicine', 'Surgery', 'Pediatrics', 'Orthopedics', 'Gynecology', 'Radiology', 'Anesthesiology'],
        entranceExam: 'NEET UG',
        highlights: ['NMC Approved', '350+ Bedded NIIMS Hospital', 'Clinical Training', 'Research Opportunities']
      },
      'B.Sc Nursing': {
        name: 'B.Sc Nursing',
        ...
        highlights: ['INC Approved', 'Clinical Training at NIIMS Hospital', 'Nursing Simulation Lab']
      },
      'B.Pharm': {
      ...
      'BPT': {
        ...
        seats: 60,
        specializations: ['Orthopedics', 'Neurology', 'Cardiothoracic', 'Sports Physiotherapy', 'Pediatrics'],
        entranceExam: 'Merit Based',
        highlights: ['Clinical Training at NIIMS Hospital', 'Modern Electrotherapy Equipment', 'Exercise Therapy Lab']
      },
      'B.Tech CSE': {
        name: 'B.Tech Computer Science & Engineering',
        duration: '4 Years (8 Semesters)',
        eligibility: '10+2 with PCM with minimum 50% marks. JEE Main/UPSEE qualified.',
        fees: '₹1,45,000/year',
        perSemesterFees: '₹72,500/semester',
        totalFees: '₹5,80,000 (Total for 4 years)',
        seats: 120,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'IoT'],
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['Advanced Computing Labs', 'Industry Certifications', 'Research Opportunities']
      },
      'MBA': {
        ...
        seats: 120,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'International Business', 'Hospital Management'],
        entranceExam: 'MAT/CAT/CMAT/UPSEE',
        highlights: ['AICTE Approved', 'Industry Focused Curriculum', 'Case Based Teaching', 'Placement Assistance']
      },
      'BA LL.B': {
    ...
    topRecruiters: [
      ...
      'Cipla', 'Sun Pharma', 'Mankind Pharma', 'The Leela', 'Oberoi Hotels',
      'Times Group', 'India Today', 'Zee News'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Computing Labs', 'Nursing Simulation Lab', 'Physiotherapy Lab',
      'Pharmacy Labs', 'Medical Simulation Lab', 'Digital Library', 'Hostel',
      ...
      'Language Lab', 'Media Lab', '350+ Bedded NIIMS Hospital', '24x7 Ambulance Service'
    ],
    contact: {
      phone: '0120-1234567',
      email: 'admissions@niu.edu.in',
      website: 'www.niu.edu.in',
      tollFree: '1800-123-4567',
      helpline: '0120-4060210'
    },
    fees: '₹57,500 - ₹6,00,000/semester',
    reviews: 1250,
    description: 'Noida International University (NIU), established in 2010 under the aegis of Maruti Educational Trust, is a premier multi-disciplinary university in Greater Noida. With UGC recognition and NAAC accreditation, NIU offers world-class education across Medical (MBBS), Nursing, Pharmacy, Physiotherapy, Allied Health Sciences, Engineering, Management, Law, and Liberal Arts. The university features a 350+ bedded NIIMS teaching hospital, 30+ international collaborations with universities across USA, UK, Australia, and Thailand, and students from over 30 countries. NIU is committed to producing globally competitive professionals through cutting-edge technology, innovative teaching methodologies, and strong industry interface.',
    specializations: [
      'Medicine', 'Surgery', 'Nursing', 'Physiotherapy', 'Pharmacy', 'Radiology',
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics',
      'Criminal Law', 'Corporate Law', 'Journalism', 'Design'
    ],
    brochure: '/brochures/noida-international-university.pdf',
    achievements: [
      'Established in 2010',
      'UGC Recognition',
      'NAAC Accreditation',
      'NMC Approval for MBBS (150 Seats)',
      'INC Approval for Nursing',
      'PCI Approval for Pharmacy',
      'BCI Approval for Law',
      '350+ Bedded NIIMS Teaching Hospital',
    ...
    facultyCount: '500+',
    globalPrograms: [
      'Student Exchange Program with Asian Institute of Technology (AIT), Bangkok',
      'Collaboration with University of Missouri, USA',
      'International Study Tours to Singapore, Malaysia, Dubai, Thailand',
    ...
    faqs: [
      { question: 'What is the eligibility for MBBS at Noida International University?', answer: '10+2 with PCB with minimum 50% marks. NEET UG qualified required. NEET UG rank will be considered for admission. 150 MBBS seats approved by NMC.' },
      { question: 'What is the fee structure for MBBS?', answer: 'MBBS fee is ₹12,00,000 per year (₹6,00,000 per semester). Total fee for 5.5 years is approximately ₹66 Lakhs.' },
      { question: 'Does NIU have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of NIU?', answer: '85% placement record with highest package ₹20 LPA and average package ₹5.2 LPA. Top recruiters include TCS, Wipro, Infosys, HCL, Apollo Hospitals, Fortis.' },
      { question: 'Is Noida International University approved by UGC?', answer: 'Yes, NIU is UGC recognized and NAAC accredited.' },
      { question: 'What are the medical courses offered at NIU?', answer: 'NIU offers MBBS (150 seats), B.Sc Nursing, B.Pharm, D.Pharm, BPT, B.Sc MLT, B.Sc Radiology, B.Sc OTT, B.Sc Cardiac Care, B.Sc Dialysis, B.Sc Optometry, B.Sc Nutrition & Dietetics.' },
      { question: 'Does NIU have a hospital?', answer: 'Yes, NIU has a 350+ bedded NIIMS multi-speciality teaching hospital on campus for clinical training of medical and paramedical students.' },
      { question: 'Does NIU offer scholarship?', answer: 'Yes, merit-based scholarships available including Freedom Fighters Scholarship (20%), Defense Scholarship (20%), Disability Scholarship (20%), Sibling Scholarship (20%), and Women\'s Scholarship (20%).' },
      { question: 'What is the admission process for MBA?', answer: 'Admission to MBA is based on MAT/CAT/CMAT scores followed by Group Discussion and Personal Interview. Minimum 50% in graduation required.' },
      { question: 'What is the global exposure at NIU?', answer: 'NIU has 30+ international collaborations with universities in USA, UK, Australia, Thailand. 850+ students have participated in Summer Education Workshop at AIT, Bangkok.' },
      { question: 'What is the alumni network strength?', answer: 'Noida International University has an alumni network of 12,000+ professionals working in top companies across India and abroad.' },
      { question: 'What are the scholarship schemes available?', answer: 'Scholarship schemes: Freedom Fighters Scholarship (20%), Defense Scholarship (20%), Disability Scholarship (20%), Sibling Scholarship (20%), Employee Scholarship (20%), Existing Student Scholarship (20%), Women\'s Scholarship (20%).' }
    ]
  };

  const getCourseDetails = (courseName: string) => {
    if (courseName.includes('MBBS')) return college.courseDetails['MBBS'];
    ...
    if (courseName.includes('B.Tech')) return college.courseDetails['B.Tech CSE'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Noida International University - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Computing Labs': Laptop, 'Nursing Simulation Lab': Stethoscope,
    'Physiotherapy Lab': Activity, 'Pharmacy Labs': FlaskConical, 'Medical Simulation Lab': Microscope,
    'Digital Library': Library, 'Hostel': Home, 'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi,
    'Auditorium': UsersRound, 'Seminar Halls': UsersRound, 'Incubation Center': Rocket,
    ...
    'Language Lab': BookOpen, 'Media Lab': Radio, '350+ Bedded NIIMS Hospital': Building2,
    '24x7 Ambulance Service': Ambulance
  };

  const medicalCourses = college.courses.filter(c => c.includes('MBBS') || c.includes('Nursing') || c.includes('Pharm') || c.includes('BPT') || c.includes('Radiology') || c.includes('MLT') || c.includes('OTT') || c.includes('Cardiac') || c.includes('Dialysis') || c.includes('Optometry') || c.includes('Nutrition'));
  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech'));
  const managementCourses = college.courses.filter(c => c.includes('MBA') || c.includes('BBA') || c.includes('BCA'));
  const lawCourses = college.courses.filter(c => c.includes('LL.B'));
  const artsCourses = college.courses.filter(c => c.includes('BAJMC') || c.includes('B.Ed') || c.includes('B.Des'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | MBBS, B.Tech, MBA in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (MBBS, B.Tech, MBA, B.Pharm, Nursing, Law). UGC | NAAC | NMC Approved | 350+ Bedded Hospital. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative h-[70vh] min-h-[600px] w-full group">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 py-8 text-white">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              <div className="flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-full"><MapPin className="w-4 h-4" />Yamuna Expressway, Greater Noida</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">30+</div><div className="text-sm text-gray-500">International Tie-ups</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Scholarships available including Freedom Fighters Scholarship (20%), Defense Scholarship (20%), Disability Scholarship (20%), Sibling Scholarship (20%), Women's Scholarship (20%). NIU has 350+ bedded NIIMS teaching hospital on campus.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ Student Exchange Program with Asian Institute of Technology (AIT), Bangkok</li><li>✓ Collaboration with University of Missouri, USA</li><li>✓ 850+ students participated in Summer Education Workshop at AIT, Bangkok</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai, Thailand</li><li>✓ Foreign Language Training (French, German, Japanese, Spanish)</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea123456789%3A0x123456789!2sNoida%20International%20University!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Noida International University Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h2 className="text-xl font-semibold mb-4">Free Counseling</h2><div className="space-y-3 mb-6"><div className="flex justify-between p-3 bg-green-50 rounded-lg"><span>Application Fee</span><span className="font-bold text-green-600">FREE</span></div><div className="flex justify-between p-3 bg-blue-50 rounded-lg"><span>Last Date</span><span className="font-bold text-blue-600">30 June 2025</span></div><div className="flex justify-between p-3 bg-purple-50 rounded-lg"><span>Scholarship</span><span className="font-bold text-purple-600">Upto 20%</span></div></div><button onClick={()=>setShowEnquiryForm(true)} className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold shadow-lg">Apply Now (Free)</button><div className="mt-4 text-center"><p className="text-xs text-gray-500">✓ 100% Free | ✓ Expert Guidance | ✓ Quick Response</p></div></div>
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">UGC, NMC, INC, PCI, BCI</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
