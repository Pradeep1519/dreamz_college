...
export function RamEeshInstitutePage() {
  ...
  const college = {
    ...
    fullName: 'Ram-Eesh Institute of Vocational & Technical Education, Greater Noida',
    location: 'Knowledge Park I, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.0,
    students: '2,500+',
    ...
    established: '1997',
    affiliation: 'Dr. A.P.J. Abdul Kalam Technical University (AKTU), Lucknow | CCS University, Meerut | Board of Technical Education, Lucknow',
    accreditation: ['AICTE', 'NBA', 'PCI', 'NCTE', 'ISO 9001:2015'],
    ranking: 'Top Pharmacy & Education Institute',
    nirfRank: 'Top 200',
    courses: [
      ...
      'International School (Nursery to XII)'
    ],
    courseDetails: {
      'B.Pharm': {
        name: 'Bachelor of Pharmacy',
        duration: '4 Years (8 Semesters)',
        eligibility: '10+2 with PCB/PCM with minimum 45% marks (40% for SC/ST). UPSEE qualified or management quota.',
        fees: '₹1,20,000/year',
        perSemesterFees: '₹60,000/semester',
        totalFees: '₹4,80,000 (Total for 4 years)',
        seats: 100,
        specializations: ['Pharmaceutics', 'Pharmacology', 'Pharmaceutical Chemistry', 'Pharmacognosy', 'Pharmacy Practice'],
        entranceExam: 'UPSEE',
        highlights: ['NBA Accredited since 2010', 'PCI Approved', 'AICTE Approved', 'Modern Labs', 'Herbal Garden', 'Industry Training']
      },
      'M.Pharm': {
        name: 'M.Pharm (Pharmaceutical Chemistry)',
        duration: '2 Years (4 Semesters)',
        eligibility: 'B.Pharm with minimum 60% marks from PCI approved institution. UPSEE qualified or management quota.',
        fees: '₹1,40,000/year',
        perSemesterFees: '₹70,000/semester',
        totalFees: '₹2,80,000 (Total for 2 years)',
        seats: 10,
        specializations: ['Pharmaceutical Chemistry', 'Drug Design', 'Medicinal Chemistry', 'Analytical Chemistry'],
        entranceExam: 'UPSEE',
        highlights: ['AICTE Approved', 'PCI Approved', 'Research Opportunities', 'Advanced Instrumentation Lab']
      },
      'D.Pharm': {
        name: 'Diploma in Pharmacy',
        duration: '2 Years (4 Semesters)',
        eligibility: '10+2 with PCB/PCM with minimum 50% marks. JEECUP qualified or management quota.',
        fees: '₹85,000/year',
        perSemesterFees: '₹42,500/semester',
        totalFees: '₹1,70,000 (Total for 2 years)',
        seats: 60,
        specializations: ['Pharmacy Practice', 'Hospital Pharmacy', 'Community Pharmacy'],
        entranceExam: 'JEECUP',
      ...
      'Diploma Engineering': {
        ...
        eligibility: '10+2 with PCM with minimum 35% marks.',
        fees: '₹65,000/year',
        perSemesterFees: '₹32,500/semester',
        totalFees: '₹1,95,000 (Total for 3 years)',
        seats: 60,
        specializations: ['Mechanical Engineering (Production)', 'Computer Science & Engineering', 'Civil Engineering', 'Electronics Engineering'],
        entranceExam: 'JEECUP',
        highlights: ['AICTE Approved', 'Modern Workshops', 'CAD/CAM Labs', 'Industry Tie-ups']
      },
      'B.Ed': {
        ...
        entranceExam: 'UPSEE',
        highlights: ['NCTE Approved', 'School Internship', 'Teaching Practice', 'CCS University Affiliated']
      }
    },
    ...
    placementRate: '82%',
    topRecruiters: [
      'Cipla', 'Sun Pharma', 'Mankind Pharma', 'Lupin', 'Dr. Reddy\'s', 'Aurobindo Pharma',
      'TCS', 'Wipro', 'Infosys', 'HCL', 'Cognizant', 'Accenture',
      'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'Apollo Hospitals', 'Fortis Healthcare',
      'Max Healthcare', 'Medanta', 'Delhi Public School', 'Amity International School'
    ],
    facilities: [
      'Smart Classrooms', 'Pharmacy Labs', 'Pharmaceutics Lab', 'Pharmacology Lab',
      'Pharmaceutical Chemistry Lab', 'Pharmacognosy Lab', 'Central Instrumentation Lab',
      'Animal House', 'Herbal Garden', 'Museum', 'Digital Library', 'Language Lab',
      'Hostel', 'Sports Complex', 'Wi-Fi Campus', 'Auditorium', 'Seminar Halls',
      'Cafeteria', 'Transport Facility', 'Medical Facility', 'Gymnasium', 'Bank/ATM',
      'Machine Room', 'CAD/CAM Labs', 'Workshops'
    ],
    contact: {
      phone: '0120-2322657',
      email: 'info@rameeshinstitutions.org',
      website: 'www.rameeshinstitutions.org',
      tollFree: '1800-123-4567',
      helpline: '0120-2322659'
    },
    fees: '₹32,000 - ₹70,000/semester',
    reviews: 980,
    description: 'Ram-Eesh Group of Institutions was established in 1997 under the aegis of Rama-Eesh Charitable Trust. The foundation stone was laid by the Chairman Dr. R.C. Sharma on November 21, 1997, and inaugurated by the former Governor of U.P., Late Shri Vishnukant Shastri on September 4, 2001. The institute offers quality education in Pharmacy (B.Pharm, M.Pharm, D.Pharm), Diploma Engineering, and Education (B.Ed). The B.Pharm program has been NBA accredited since 2010. Ram-Eesh has collaborations with Shriram Research Institute, Pharmazz India Pvt. Ltd., Kopran Pharmaceutical, vLife Technologies, and Enoble IP for Research & Development. The institute boasts a library with 60,000+ books, well-equipped labs, and excellent hostel facilities.',
    specializations: [
      'Pharmaceutics', 'Pharmacology', 'Pharmaceutical Chemistry', 'Pharmacognosy',
      'Mechanical Engineering', 'Computer Science', 'Civil Engineering', 'Electronics Engineering',
      'Teaching Methodology', 'Educational Psychology'
    ],
    brochure: '/brochures/ram-eesh-institute.pdf',
    achievements: [
      'Established in 1997 - 25+ Years of Excellence',
      'NBA Accredited B.Pharm Program since 2010',
      'AICTE & PCI Approved',
      'NCTE Approved for B.Ed',
      'Government Sponsored Research Projects under AICTE, DST & MSME',
      'Institute-Industry Collaboration with Shriram Research Institute, Pharmazz India, Kopran Pharmaceutical',
      'Library with 60,000+ Books',
      'Herbal Garden for Medicinal Plant Cultivation',
      'Central Instrumentation Lab with HPLC, IR, UV Spectrophotometer'
    ],
    alumniCount: '8,000+',
    facultyCount: '150+',
    globalPrograms: [
    ...
    faqs: [
      { question: 'What is the eligibility for B.Pharm at Ram-Eesh Institute?', answer: '10+2 with PCB/PCM with minimum 45% marks (40% for SC/ST). UPSEE qualified or management quota admission.' },
      { question: 'What is the fee structure for B.Pharm?', answer: 'B.Pharm fee is ₹1,20,000 per year (₹60,000 per semester). Total fee for 4 years is approximately ₹4.8 Lakhs.' },
      { question: 'Does Ram-Eesh Institute have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with spacious, airy, well-furnished rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year with mess facility.' },
      { question: 'What is the placement record of Ram-Eesh?', answer: '82% placement record with highest package ₹12 LPA and average package ₹4.5 LPA. Top recruiters include Cipla, Sun Pharma, Mankind Pharma, TCS, Wipro.' },
      { question: 'Is Ram-Eesh Institute approved by AICTE?', answer: 'Yes, Ram-Eesh is approved by AICTE, PCI, and NCTE. B.Pharm program is NBA accredited since 2010.' },
      { question: 'What are the pharmacy courses offered?', answer: 'Ram-Eesh offers B.Pharm (100 seats), M.Pharm in Pharmaceutical Chemistry (10 seats), and D.Pharm (60 seats). All courses are PCI approved.' },
      { question: 'Does Ram-Eesh offer scholarship?', answer: 'Yes, scholarship and fee concession given to poor and meritorious students by the Institutes and by the Samaj Kalyan Department.' },
      { question: 'What are the research facilities available?', answer: 'Ram-Eesh has government sponsored research projects under AICTE, DST & MSME. Institute has collaborations with Shriram Research Institute, Pharmazz India, Kopran Pharmaceutical, vLife Technologies, and Enoble IP for R&D.' },
      { question: 'What is the library collection?', answer: 'Ram-Eesh has a library with 60,000+ books, 20,000+ titles, educational journals, magazines, newspapers, encyclopedias, and dictionaries.' },
      { question: 'What is the alumni network strength?', answer: 'Ram-Eesh has an alumni network of 8,000+ professionals working in top pharmaceutical companies, IT companies, and educational institutions across India and abroad.' },
      { question: 'What are the facilities available at Ram-Eesh?', answer: 'Ram-Eesh has smart classrooms, modern pharmacy labs (Pharmaceutics, Pharmacology, Pharmaceutical Chemistry, Pharmacognosy), central instrumentation lab (HPLC, IR, UV), animal house, herbal garden, museum, digital library, language lab, sports complex, gymnasium, and hostel.' },
      { question: 'What is the admission process for Diploma Engineering?', answer: 'Admission to Diploma Engineering is based on JEECUP score or management quota. Eligibility: 10+2 with PCM with minimum 35% marks.' }
    ]
  };

  const getCourseDetails = (courseName: string) => {
    if (courseName.includes('B.Pharm')) return college.courseDetails['B.Pharm'];
    if (courseName.includes('M.Pharm')) return college.courseDetails['M.Pharm'];
    if (courseName.includes('D.Pharm')) return college.courseDetails['D.Pharm'];
    if (courseName.includes('Diploma')) return college.courseDetails['Diploma Engineering'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Ram-Eesh Institute - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Pharmacy Labs': FlaskConical, 'Pharmaceutics Lab': FlaskConical,
    'Pharmacology Lab': Microscope, 'Pharmaceutical Chemistry Lab': FlaskConical, 'Pharmacognosy Lab': Flower,
    'Central Instrumentation Lab': Microscope, 'Animal House': Building2, 'Herbal Garden': Flower,
    'Museum': Building2, 'Digital Library': Library, 'Language Lab': BookOpen, 'Hostel': Home,
    'Sports Complex': Dumbbell, 'Wi-Fi Campus': Wifi, 'Auditorium': UsersRound, 'Seminar Halls': UsersRound,
    'Cafeteria': Coffee, 'Transport Facility': Bus, 'Medical Facility': Heart, 'Gymnasium': Dumbbell,
    'Bank/ATM': Shield, 'Machine Room': Laptop, 'CAD/CAM Labs': Laptop, 'Workshops': Car
  };

  const pharmacyCourses = college.courses.filter(c => c.includes('Pharm'));
  const engineeringCourses = college.courses.filter(c => c.includes('Diploma'));
  const educationCourses = college.courses.filter(c => c.includes('B.Ed'));

  return (
    <>
      <Helmet><title>{college.name} - Fees, Placements, Ranking 2026 | Top Pharmacy College in Greater Noida</title>
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Pharm, M.Pharm, D.Pharm, Diploma Engineering, B.Ed). NBA Accredited | PCI Approved | 25+ Years of Excellence. Get free counseling for 2026 admissions!`} /></Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  {engineeringCourses.length > 0 && (<div className="bg-white rounded-xl p-6 shadow-sm"><h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><Cap className="w-5 h-5 text-purple-600" /> Diploma Engineering Programs</h2><div className="space-y-4">{engineeringCourses.map((course,i)=>{const details=getCourseDetails(course);return(<div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-purple-200 hover:bg-purple-50/30"><div className="flex flex-wrap justify-between items-start gap-2 mb-2"><h3 className="font-semibold text-gray-900">{course}</h3><div className="text-right"><span className="text-purple-600 font-bold block">{details?.perSemesterFees || 'Contact'}</span>{details?.totalFees && <span className="text-xs text-gray-500">({details.totalFees})</span>}</div></div>{details && (<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm"><div><span className="text-gray-500">Duration:</span><p className="font-medium text-gray-800">{details.duration}</p></div><div><span className="text-gray-500">Seats:</span><p className="font-medium text-gray-800">{details.seats || 'Contact'}</p></div><div><span className="text-gray-500">Eligibility:</span><p className="font-medium text-gray-800 text-xs">{details.eligibility.substring(0,50)}...</p></div><div><span className="text-gray-500">Entrance:</span><p className="font-medium text-gray-800">{details.entranceExam}</p></div></div>)}{details?.specializations && (<div className="mt-3 flex flex-wrap gap-2">{details.specializations.slice(0,4).map((spec,j)=><span key={j} className="px-2 py-1 bg-gray-100 text-gray-600 rounded-full text-xs">{spec}</span>)}</div>)}</div>)})}</div></div>)}
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. Mess facility available with good quality food. Ram-Eesh has collaborations with Shriram Research Institute, Pharmazz India, Kopran Pharmaceutical, vLife Technologies, and Enoble IP for Research & Development.</p></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea123456789%3A0x123456789!2sRam-Eesh%20Institute%20of%20Vocational%20%26%20Technical%20Education!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="Ram-Eesh Institute Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">AICTE, NBA, PCI, NCTE</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
