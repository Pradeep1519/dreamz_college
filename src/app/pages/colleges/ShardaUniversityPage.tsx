...
export function ShardaUniversityPage() {
  ...
  const college = {
    ...
    location: 'Knowledge Park III, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.3,
    students: '12,000+',
    ...
    established: '2009',
    affiliation: 'UGC',
    accreditation: ['NAAC A+', 'NIRF Rank 86', 'QS Asia Ranking', 'NBA'],
    ...
    courseDetails: {
      'B.Tech CSE': {
        ...
        eligibility: '10+2 with PCM with minimum 60% marks. JEE Main/SUAT qualified.',
        fees: '₹2,70,000/year',
        ...
        entranceExam: 'JEE Main/SUAT',
        highlights: ['NBA Accredited', 'NVIDIA Super Computer', 'AI Labs', 'Research Opportunities']
      },
      'B.Tech CSE AI ML': {
        ...
        entranceExam: 'JEE Main/SUAT',
        highlights: ['AI Specialization', 'Industry Projects', 'NVIDIA DGX H100 Super Computer']
      },
      'B.Tech CSE DS': {
      ...
      'MBA': {
        ...
        seats: 180,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'International Business', 'Healthcare Management', 'Digital Marketing'],
        entranceExam: 'MAT/CAT/CMAT/SUAT',
        highlights: ['AICTE Approved', 'Industry Focused Curriculum', 'Global Exposure', '100% Placement Assistance']
      },
      'MBBS': {
        ...
        fees: '₹12,69,319/year',
        perSemesterFees: '₹6,34,660/semester',
        totalFees: '₹57,11,936 (Total for 4.5 years)',
        seats: 250,
        specializations: ['Medicine', 'Surgery', 'Pediatrics', 'Orthopedics', 'Gynecology'],
        entranceExam: 'NEET UG',
        highlights: ['NMC Approved', '1800+ Bed Hospital', 'Clinical Training', 'Research Opportunities']
      },
      'BDS': {
        ...
        seats: 100,
        specializations: ['Oral Medicine', 'Oral Surgery', 'Orthodontics', 'Periodontics'],
        entranceExam: 'NEET UG',
        highlights: ['DCI Approved', 'Dental Hospital', 'Clinical Training']
      },
      'B.Pharm': {
        ...
        fees: '₹2,40,000/year',
        perSemesterFees: '₹1,22,500/semester',
        totalFees: '₹9,60,000 (Total for 4 years)',
        seats: 100,
      ...
      'B.Sc Nursing': {
        ...
        totalFees: '₹9,60,000 (Total for 4 years)',
        seats: 100,
        specializations: ['Medical Surgical Nursing', 'Community Health Nursing', 'Pediatric Nursing', 'Psychiatric Nursing'],
        entranceExam: 'Merit Based',
        highlights: ['INC Approved', 'Clinical Training', 'Hospital Exposure']
      },
      'BBA': {
        ...
        fees: '₹2,31,000/year',
        perSemesterFees: '₹1,18,000/semester',
        totalFees: '₹6,93,000 (Total for 3 years)',
        seats: 180,
    ...
    placementRate: '88%',
    topRecruiters: [
      'Cognizant', 'TCS', 'Wipro', 'HCL', 'Infosys', 'Accenture', 'Deloitte',
      'KPMG', 'Amazon', 'Microsoft', 'IBM', 'Tech Mahindra', 'Capgemini',
      'Apollo Hospitals', 'Fortis Healthcare', 'Max Healthcare', 'Sun Pharma',
      'Cipla', 'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'BYJU\'s'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Labs', 'NVIDIA Super Computer', 'Digital Library',
      ...
      'Gymnasium', 'Bank/ATM', '1800+ Bed Hospital', 'Dental Hospital'
    ],
    contact: {
      phone: '0120-4570000',
    ...
    fees: '₹1,37,500 - ₹6,34,660/semester',
    reviews: 1250,
    description: 'Sharda University is a leading multi-disciplinary university in Greater Noida, established in 2009. With NAAC A+ accreditation and NIRF Rank 86, Sharda offers world-class education across Engineering, Medical, Dental, Pharmacy, Nursing, Management, Law, and Design. The university boasts a 63-acre campus with state-of-the-art infrastructure, 1800+ bed teaching hospital, and students from 95+ countries.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'Healthcare Management',
      'Medicine', 'Surgery', 'Dentistry', 'Pharmacy', 'Nursing'
    ],
    brochure: '/brochures/sharda-university.pdf',
    achievements: [
      'NAAC A+ Grade',
      'NIRF Rank 86',
      'QS Asia University Ranking',
      'Top Multi-Disciplinary University',
      'NVIDIA Super Computer DGX H100',
      '1800+ Bed Teaching Hospital',
    ...
    faqs: [
      { question: 'What is the eligibility for MBBS at Sharda University?', answer: '10+2 with PCB and minimum 50% marks. NEET UG qualified required. NEET UG rank will be considered for admission.' },
      ...
      { question: 'Does Sharda University have hostel facilities?', answer: 'Yes, Sharda University has separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,20,000 to ₹2,28,000 per year.' },
      { question: 'What is the placement record of Sharda University?', answer: '88% placement record with highest package ₹42 LPA and average package ₹5.8 LPA. Top recruiters include Cognizant, TCS, Wipro, HCL, and Apollo Hospitals.' },
      { question: 'Is Sharda University approved by UGC?', answer: 'Yes, Sharda University is UGC approved and NAAC A+ accredited. NIRF Rank 86.' },
      { question: 'What are the specializations available in B.Tech?', answer: 'Sharda University offers B.Tech in CSE, AI & ML, Data Science, Cyber Security, Cloud Computing, IoT, ECE, ME, Civil, Biotechnology, and Food Technology.' },
      { question: 'Does Sharda University offer scholarship?', answer: 'Yes, merit-based scholarships up to 100% available based on 10+2 marks, JEE Main percentile, or CUET score.' },
      { question: 'What is the admission process for MBA?', answer: 'Admission to MBA is based on MAT/CAT/CMAT/XAT scores followed by Group Discussion and Personal Interview. Minimum 50% in graduation required.' },
      { question: 'Does Sharda University have a hospital?', answer: 'Yes, Sharda University has a 1800+ bed super-specialty teaching hospital for medical students and patient care.' },
      { question: 'What is the global exposure at Sharda University?', answer: 'Sharda has 300+ international tie-ups with universities in USA, UK, Australia, France, and offers credit transfer and semester exchange programs.' }
    ]
  };
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'Sharda University - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Labs': Laptop, 'NVIDIA Super Computer': Zap,
    ...
    'Bank/ATM': Shield, '1800+ Bed Hospital': Building, 'Dental Hospital': Building
  };

  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech') && !c.includes('Biotech') && !c.includes('Food'));
  const medicalCourses = college.courses.filter(c => c.includes('MBBS') || c.includes('BDS') || c.includes('Nursing'));
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (MBBS, B.Tech, MBA, B.Pharm, B.Sc Nursing). NAAC A+ | NIRF Rank 86. Get free counseling for 2026 admissions!`} /></Helmet>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,20,000 - ₹2,28,000/year. Scholarships available for meritorious students up to 100%.</p></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ Credit Transfer Program with 300+ Global Universities</li><li>✓ Semester Exchange Program (Zero Tuition Fee)</li><li>✓ International Study Tours to UK, USA, Australia, France</li><li>✓ Foreign Language Training (French, German, Japanese, Spanish)</li></ul></div>
                </div>
              )}
