...
import { 
  ...
  Landmark, Newspaper, Video, Monitor, Headphones
} from 'lucide-react';
...
export function UnitedCollegeOfEducationPage() {
  ...
  const college = {
    ...
    fullName: 'United Group of Institutions - United College of Education, Greater Noida',
    location: '50-B, Knowledge Park III, Near Metro Station, Greater Noida, Uttar Pradesh - 201306',
    rating: 4.3,
    students: '8,500+',
    ...
    established: '1998',
    affiliation: 'AKTU, Lucknow | CCS University, Meerut | GGSIP University, Delhi | BTE, UP | Allahabad State University',
    accreditation: ['NAAC Grade A', 'AICTE', 'NBA', 'PCI', 'BCI', 'NCTE', 'ISO 9001:2015'],
    ...
    courses: [
      ...
      'M.Tech CAD (Computer Aided Design)',
      ...
      'B.Com (Hons.) - Accounting & Finance with ACCA',
      'BA LL.B (Integrated)',
      'BBA LL.B (Integrated)',
      ...
      'Diploma Engineering (Civil, Mechanical, Electrical, Electronics, Computer Science)'
    ],
    courseDetails: {
      'B.Tech CSE': {
        ...
        seats: 180,
        specializations: ['AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing', 'IoT', 'Blockchain', 'Full Stack Development'],
        entranceExam: 'JEE Main/UPSEE',
        highlights: ['NBA Accredited', 'Advanced Computing Labs', 'NVIDIA AI Lab', 'Research Center']
      },
      'B.Tech CSE AIML': {
      ...
      'MBA': {
        ...
        fees: '₹1,75,000/year',
        perSemesterFees: '₹87,500/semester',
        totalFees: '₹3,50,000 (Total for 2 years)',
        seats: 180,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'International Business', 'Operations', 'Information Technology'],
      ...
      'BBA': {
        ...
        totalFees: '₹3,75,000 (Total for 3 years)',
        seats: 240,
        specializations: ['Marketing', 'Finance', 'Human Resource', 'International Business', 'Business Analytics'],
      ...
      'BCA': {
        ...
        totalFees: '₹3,45,000 (Total for 3 years)',
        seats: 180,
      ...
      'BA LL.B': {
        ...
        fees: '₹1,40,000/year',
        perSemesterFees: '₹70,000/semester',
        totalFees: '₹7,00,000 (Total for 5 years)',
        seats: 120,
      ...
      'BAJMC': {
        ...
        duration: '3 Years (6 Semesters)',
        eligibility: '10+2 with minimum 50% marks. English as a subject.',
        fees: '₹1,10,000/year',
        perSemesterFees: '₹55,000/semester',
        totalFees: '₹3,30,000 (Total for 3 years)',
        seats: 60,
        specializations: ['Print Journalism', 'Electronic Media', 'Digital Media', 'Advertising', 'Public Relations', 'Radio Production'],
        entranceExam: 'GGSIPU CET',
        highlights: ['GGSIP University Grade A Institute', 'Media Lab', 'Radio Studio', 'TV Studio', 'Industry Training']
      },
      'B.Pharm': {
    ...
    topRecruiters: [
      ...
      'Capgemini', 'Deloitte', 'KPMG', 'EY', 'PwC', 'IBM', 'Amazon', 'Microsoft',
      'Flipkart', 'Paytm', 'ICICI Bank', 'HDFC Bank', 'Axis Bank', 'Kotak Mahindra',
      'Cipla', 'Sun Pharma', 'Mankind Pharma', 'Apollo Hospitals', 'Fortis Healthcare',
      'Times Group', 'India Today', 'Zee News', 'Republic TV', 'NDTV',
      'The Leela', 'Oberoi Hotels', 'ITC Hotels', 'Radisson'
    ],
    facilities: [
      'Smart Classrooms', 'Advanced Computing Labs', 'NVIDIA AI Lab', 'Apple iMac Lab',
      'Pharmacy Labs', 'Central Instrumentation Lab', 'Moot Court', 'Media Lab',
      'Radio Studio', 'TV Studio', 'Digital Library', 'Language Lab',
      ...
      'Largest Sports Complex in UP', '50,000 Sqft Area', '2,78,000+ Books in Library'
    ],
    contact: {
      phone: '1800-103-3171',
      email: 'info@united.ac.in',
      website: 'www.united.ac.in',
      tollFree: '1800-103-3171',
      helpline: '8826890046'
    },
    fees: '₹32,000 - ₹1,57,200/semester',
    reviews: 1250,
    description: 'United Group of Institutions (UGI) is one of the premier educational groups in North India, established in 1998 with a vision to provide state-of-the-art environment for real and lifelong learning. With NAAC Grade A accreditation and multiple campuses across Greater Noida and Allahabad, UGI offers over 50 programs across Engineering, Management, Pharmacy, Law, Education, Journalism, and Commerce. The group boasts a 200+ acre campus with the largest sports complex in UP, 2,78,000+ books in the library, and academic collaborations with Missouri University, USA and Asian Institute of Technology, Thailand. UGI has been ranked 4th in UP for B.Tech, 2nd in UP for MBA, and 9th in UP for B.Pharm. The institute has a strong placement record with 1,436 placements in 94 companies for the batch 2021.',
    specializations: [
      'Computer Science', 'AI & ML', 'Data Science', 'Cyber Security', 'Cloud Computing',
      'Marketing', 'Finance', 'Human Resource', 'Business Analytics', 'Operations',
      'Criminal Law', 'Corporate Law', 'Constitutional Law',
      'Print Journalism', 'Electronic Media', 'Digital Media',
      'Pharmaceutics', 'Pharmacology', 'Pharmaceutical Chemistry'
    ],
    brochure: '/brochures/united-college-of-education.pdf',
    achievements: [
      'Established in 1998 - 25+ Years of Excellence',
      'NAAC Grade A Institute',
      'Ranked 4th in UP (overall for B.Tech)',
      'Ranked 2nd in UP (overall for MBA)',
      'Ranked 9th in UP (overall for B.Pharm)',
      '57 students scored above 90% marks',
      '198 students secured above 80% marks',
      'UPPCS Toppers for 3 years in a row',
      'Largest Sports Complex in UP',
      '2,78,000+ Books in Library',
      'MoU with Missouri University, USA',
      'MoU with Asian Institute of Technology, Thailand',
      '850+ students participated in Summer Education Workshop at AIT',
      'TCS Accredited - Largest Online Center in UP',
      'Infosys & Wipro Campus Placement Hub'
    ],
    alumniCount: '25,000+',
    facultyCount: '600+',
    globalPrograms: [
      'MoU with Missouri University, Columbia, USA - 3 Week Summer Program',
      'MoU with Asian Institute of Technology (AIT), Bangkok, Thailand',
      'Summer Education Workshop at AIT, Bangkok (850+ students participated)',
      ...
      'Joint Research Projects with International Universities'
    ],
    faqs: [
      { question: 'What is the eligibility for B.Tech at United Group?', answer: '10+2 with PCM with minimum 45% marks. JEE Main/UPSEE score is also accepted.' },
      ...
      { question: 'Does United Group have hostel facilities?', answer: 'Yes, separate hostels for boys and girls with AC and Non-AC rooms. Hostel fees range from ₹1,10,000 to ₹1,45,000 per year.' },
      { question: 'What is the placement record of United Group?', answer: '88% placement record with highest package ₹32 LPA and average package ₹5.2 LPA. 1,436 placements in 94 companies (Batch 2021). Top recruiters include TCS, Wipro, Infosys, HCL, Amazon, Deloitte.' },
      { question: 'Is United Group approved by AICTE?', answer: 'Yes, United Group is approved by AICTE, NAAC Grade A accredited, and NBA accredited for multiple programs.' },
      { question: 'What are the courses offered at United Group?', answer: 'United Group offers B.Tech, M.Tech, MBA, MCA, BBA, BCA, B.Com, BA LL.B, BBA LL.B, BAJMC, B.Pharm, M.Pharm, D.Pharm, Diploma Engineering, and B.Ed across multiple campuses.' },
      { question: 'Does United Group offer scholarship?', answer: 'Yes, merit-based scholarships up to ₹20,000 available for BBA/BCA students based on 12th marks, and up to ₹20,000 for MBA students based on graduation marks and entrance exam percentile.' },
      { question: 'What is the ranking of United Group?', answer: 'United Group is ranked 4th in UP for B.Tech, 2nd in UP for MBA, and 9th in UP for B.Pharm.' },
      { question: 'What is the global exposure at United Group?', answer: 'United Group has MoU with Missouri University, USA and Asian Institute of Technology, Thailand. 850+ students have participated in Summer Education Workshop at AIT, Bangkok.' },
      { question: 'What is the library collection?', answer: 'United Group has a library with 2,78,000+ titles/books, magazines, journals, and access to Nalanda E-Consortium (IEEE, SPRINGER, ELSEVIER).' },
      { question: 'What is the admission process for BAJMC?', answer: 'Admission to BAJMC is based on GGSIPU CET score. Eligibility: 10+2 with minimum 50% marks with English as a subject.' },
      { question: 'What are the facilities available at United Group?', answer: 'United Group has smart classrooms, advanced labs, NVIDIA AI Lab, Apple iMac Lab, media lab, radio studio, TV studio, moot court, largest sports complex in UP, hostel, cafeteria, transport, medical facility, gymnasium, and bank/ATM.' }
    ]
  };
  ...
  const getCourseDetails = (courseName: string) => {
    ...
    if (courseName.includes('BAJMC')) return college.courseDetails['BAJMC'];
  ...
  const submitToGoogleSheets = async (data: any) => {
    try {
      ...
      formData.append('timestamp', new Date().toISOString()); formData.append('source', 'United Group - Apply Now');
  ...
  const facilityIcons: { [key: string]: any } = {
    'Smart Classrooms': GraduationCap, 'Advanced Computing Labs': Laptop, 'NVIDIA AI Lab': Zap,
    'Apple iMac Lab': Laptop, 'Pharmacy Labs': FlaskConical, 'Central Instrumentation Lab': Microscope,
    'Moot Court': Gavel, 'Media Lab': Video, 'Radio Studio': Radio, 'TV Studio': Monitor,
    'Digital Library': Library, 'Language Lab': BookOpen, 'Hostel': Home, 'Sports Complex': Dumbbell,
    ...
    'Gymnasium': Dumbbell, 'Bank/ATM': Shield, 'Herbal Garden': Flower,
    'Largest Sports Complex in UP': Trophy, '50,000 Sqft Area': Building2, '2,78,000+ Books in Library': Library
  };

  const engineeringCourses = college.courses.filter(c => c.includes('B.Tech') || c.includes('M.Tech') || c.includes('Diploma'));
  const managementCourses = college.courses.filter(c => c.includes('MBA') || c.includes('BBA') || c.includes('BCA') || c.includes('MCA') || c.includes('B.Com'));
  ...
  return (
    <>
      ...
      <meta name="description" content={`${college.name} - Explore fees (${college.fees}), placement packages (${college.highestPackage}), courses offered (B.Tech, MBA, BCA, Law, Journalism). NAAC Grade A | Ranked 4th in UP for B.Tech | 2,78,000+ Books. Get free counseling for 2026 admissions!`} /></Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 relative z-20">
          <div className="bg-white rounded-2xl shadow-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="w-16 h-16 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center"><Award className="w-8 h-8 text-purple-600" /></div><div className="font-bold text-2xl text-gray-900">25+</div><div className="text-sm text-gray-500">Years of Excellence</div></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'courses' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4"><p className="text-sm text-gray-600"><span className="font-semibold">Note:</span> Hostel fees: ₹1,10,000 - ₹1,45,000/year. United Group has the largest sports complex in UP with 50,000 sqft area. Library has 2,78,000+ books. Scholarships available for meritorious students (up to ₹20,000).</p></div>
                </div>
              )}
              ...
              {activeTab === 'placements' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="bg-purple-50 rounded-lg p-4"><h4 className="font-semibold text-gray-800 mb-2">Placement USPs</h4><ul className="space-y-2 text-sm"><li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />100% placement assistance with training in aptitude, soft skills, and technical interviews</li><li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />Mentor-mentee system for personalized career guidance</li><li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />Regular mock interviews and group discussion sessions</li><li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />1,436 placements in 94 companies (Batch 2021)</li><li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />TCS Accredited - Largest Online Center in UP</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'global' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg"><h3 className="font-semibold text-gray-800 mb-2">International Exposure Highlights</h3><ul className="space-y-2 text-sm text-gray-600"><li>✓ MoU with Missouri University, Columbia, USA - 3 Week Summer Program</li><li>✓ MoU with Asian Institute of Technology (AIT), Bangkok, Thailand</li><li>✓ 850+ students participated in Summer Education Workshop at AIT, Bangkok</li><li>✓ Student Exchange Programs with International Universities</li><li>✓ International Study Tours to Singapore, Malaysia, Dubai, Thailand</li><li>✓ Foreign Language Training (French, German, Japanese, Spanish)</li></ul></div>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="mt-6"><h3 className="font-semibold mb-2">Location</h3><div className="bg-gray-100 rounded-lg h-48"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.774!2d77.496!3d28.501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea123456789%3A0x123456789!2sUnited%20College%20of%20Education!5e0!3m2!1sen!2sin!4v1" width="100%" height="100%" style={{border:0}} allowFullScreen loading="lazy" title="United College of Education Location"></iframe></div><p className="text-sm text-gray-500 mt-2">{college.location}</p></div>
                </div>
              )}
            </div>
            ...
            <div className="lg:col-span-1"><div className="sticky top-16 space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h2 className="text-xl font-semibold mb-4">Free Counseling</h2><div className="space-y-3 mb-6"><div className="flex justify-between p-3 bg-green-50 rounded-lg"><span>Application Fee</span><span className="font-bold text-green-600">FREE</span></div><div className="flex justify-between p-3 bg-blue-50 rounded-lg"><span>Last Date</span><span className="font-bold text-blue-600">30 June 2025</span></div><div className="flex justify-between p-3 bg-purple-50 rounded-lg"><span>Scholarship</span><span className="font-bold text-purple-600">Upto ₹20,000</span></div></div><button onClick={()=>setShowEnquiryForm(true)} className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold shadow-lg">Apply Now (Free)</button><div className="mt-4 text-center"><p className="text-xs text-gray-500">✓ 100% Free | ✓ Expert Guidance | ✓ Quick Response</p></div></div>
              <div className="bg-white rounded-xl p-6 shadow-sm border"><h3 className="font-semibold mb-3">Quick Facts</h3><div className="space-y-2 text-sm"><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Established</span><span className="font-medium">{college.established}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Approvals</span><span className="font-medium">NAAC A, AICTE, NBA, PCI, BCI</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Student Strength</span><span className="font-medium">{college.students}</span></div><div className="flex justify-between py-2 border-b"><span className="text-gray-500">Faculty Members</span><span className="font-medium">{college.facultyCount}</span></div><div className="flex justify-between py-2"><span className="text-gray-500">Alumni Network</span><span className="font-medium">{college.alumniCount}</span></div></div></div>
            </div></div>
          </div>
        </div>
